package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomSessionChatEvent.const_460];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_460:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_729);
         _loc1_.push(RoomWidgetChatTypingMessage.const_737);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_729:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_737:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_132.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_575,HabboToolbarIconEnum.CHATINPUT,param1));
