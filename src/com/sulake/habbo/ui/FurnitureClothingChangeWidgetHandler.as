package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1176:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      
      private static const const_1177:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         this._container.roomSession.sendUpdateClothingChangeFurniture(this.var_288,param2,param1);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_664,RoomWidgetClothingChangeMessage.const_317,RoomWidgetAvatarEditorMessage.const_350];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_664:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc8_)
                     {
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_324,_loc6_.id,_loc6_.category,_loc6_.roomId,_loc6_.roomCategory);
            ...
            case RoomWidgetClothingChangeMessage.const_317:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     this.var_288 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_918);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1177;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1047);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1176;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_238,AvatarEditorFigureCategory.const_573],true))
                     {
                        _loc11_ = 0;
                        ...
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_324,_loc7_.objectId,_loc7_.objectCategory,_loc7_.roomId,_loc7_.roomCategory);
                        this._container.events.dispatchEvent(_loc5_);
                     }
                  }
               }
