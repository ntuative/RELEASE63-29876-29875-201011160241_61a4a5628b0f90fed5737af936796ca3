package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_613,RoomWidgetStickieSendUpdateMessage.const_633,RoomWidgetStickieSendUpdateMessage.const_401];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_613:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_909);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_401:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_633:
