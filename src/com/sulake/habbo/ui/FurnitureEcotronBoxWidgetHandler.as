package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_748,RoomWidgetEcotronBoxOpenMessage.const_563,RoomWidgetEcotronBoxOpenedMessage.const_1447];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_748:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_563:
