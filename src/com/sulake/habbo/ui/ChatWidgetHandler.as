package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_656:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_363 != null)
         {
            ...
            {
               _loc2_ = this.var_363.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_363.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_811.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_202:
                                       _loc17_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc16_,AvatarScaleType.SMALL,this);
                                       if(_loc17_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.SMALL,null,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_202)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_364.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_363.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_811.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_604,RoomWidgetChatSelectAvatarMessage.const_739];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_604:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_739:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1000 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1000);
            }
            if(this.var_656 == null)
            {
               ...
               this.var_450.y = 0;
               this.var_450.z = 0;
               this.var_656 = _loc4_.getScreenPoint(this.var_450);
               this.var_1000 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_450.x = 0;
            this.var_450.y = 0;
            this.var_450.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_450);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_656.x || _loc8_.y != this.var_656.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_656,_loc5_));
