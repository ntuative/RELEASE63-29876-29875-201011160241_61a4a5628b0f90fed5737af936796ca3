   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_152,this.onUserTags);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_152,this.onUserTags);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_665);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_310);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_932);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_202)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_910)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_209)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_769);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1408;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_961;
                  }
                  if(!_loc27_)
                  {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = this._container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_51,_loc18_);
               if(_loc19_ != null)
               {
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_51,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_608.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_51);
            this.var_608.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_769);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_795);
         _loc1_.push(RoomWidgetPetCommandMessage.const_554);
         _loc1_.push(RoomWidgetUserActionMessage.const_416);
         _loc1_.push(RoomWidgetUserActionMessage.const_334);
         return _loc1_;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_608.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_608.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_521)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_334 || param1.type == RoomWidgetUserActionMessage.const_416 || param1.type == RoomWidgetUserActionMessage.const_395)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_774:
               ...
               break;
            case RoomWidgetUserActionMessage.const_775:
            ...
            case RoomWidgetUserActionMessage.const_395:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_636:
            ...
            case RoomWidgetFurniActionMessage.const_747:
               ...
               break;
            case RoomWidgetUserActionMessage.const_334:
            ...
            case RoomWidgetRoomTagSearchMessage.const_608:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_768:
            ...
            case RoomWidgetPetCommandMessage.const_554:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_795:
