package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_112:
               ...
               this._container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_558,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_731];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_731:
      ...
      {
         return [RoomSessionDoorbellEvent.const_112,RoomSessionDoorbellEvent.const_132,RoomSessionDoorbellEvent.const_46];
      }
