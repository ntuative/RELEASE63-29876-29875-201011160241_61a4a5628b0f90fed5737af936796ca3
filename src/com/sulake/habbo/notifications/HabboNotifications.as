package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1168:String = "badges";
      
      private static const const_1170:String = "pet_inventory";
      
      private static const const_1167:String = "pixelbalance";
      
      private static const const_1165:String = "credits";
      
      private static const const_1166:String = "inventory";
      
      private static const const_1172:String = "friendlist";
      
      private static const const_1171:String = "selectfurni";
      
      private static const const_1169:String = "selectbadge";
       
      
      private var var_798:ClubPromoNotification;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_646:ParkBusDialogManager;
      
      private var var_645:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_441:HabboNotificationViewManager;
      
      private var var_439:IAvatarRenderManager;
      
      private var var_800:ClubEndingNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_801);
         }
         var _loc6_:Map = this.var_801["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_439.createAvatarImage(param2,AvatarScaleType.const_51);
         if(_loc7_ != null)
         {
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1440);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_997)
         {
            return;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_645)
         {
            this.var_645.release(new IIDHabboToolbar());
            this.var_645 = null;
         }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1341);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2237)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_899);
            this.var_2237 = true;
      ...
      function onAchievementBonus(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotificationBonus(_loc2_.bonusPoints,assets,this._windowManager,this._localization);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_899,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_439.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_952,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_162 || param2.type == WindowEvent.const_780)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(this.var_441.isSpaceAvailable() && this.var_987.length > 0)
         {
            this.var_441.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_646 == null)
         {
            this.var_646 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_646 != null)
         {
            this.var_646.handleParkBusCannotEnter(_loc2_.method_2);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_987.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_439.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_801["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         return this.var_987.length;
      }
      
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         if(param1 != null && this.var_441 != null)
         {
            this.var_441.replaceIcon(param1);
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_360.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_77)
               {
                  _loc9_ = this.var_360.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_360.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1396,_loc5_);
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1236[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.pixels,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_360);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1236[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1236[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_645 = IHabboToolbar(param2);
         this.var_645.events.addEventListener(HabboToolbarEvent.const_61,this.onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1427)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_800 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_798 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_360.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_915);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_915);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_61)
         {
            ...
            this.var_441 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_801["styles"],this.var_801["view"],this.var_645);
            ...
            registerUpdateReceiver(this.var_441,1);
            registerUpdateReceiver(this,2);
            this.var_360.events.addEventListener(BadgeImageReadyEvent.const_121,this.onBadgeImage);
            this.var_645.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
   }
}
