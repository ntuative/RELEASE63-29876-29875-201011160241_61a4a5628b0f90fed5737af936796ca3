package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_925:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_925.getValue());
         return _loc2_;
      }
      ...
      public function onInit(param1:IWindowContainer, param2:HabboUserDefinedRoomEvents) : void
      {
         ...
         this.var_925 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_925.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_925.setValue(1);
      }
      ...
      {
         return ActionTypeCodes.var_1829;
      }
