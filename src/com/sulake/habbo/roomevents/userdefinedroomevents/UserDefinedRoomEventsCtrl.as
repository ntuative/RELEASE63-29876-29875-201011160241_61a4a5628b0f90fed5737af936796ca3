package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_148:UserDefinedRoomEventsHelp;
      
      private var var_1740:ActionTypes;
      
      private var var_1739:ConditionTypes;
      
      private var var_699:RoomObjectHightLighter;
      
      private var var_1741:TriggerConfs;
      ...
      {
         this.var_1741 = new TriggerConfs();
         this.var_1740 = new ActionTypes();
         this.var_1739 = new ConditionTypes();
         this.var_235 = new Dictionary();
         super();
         this.var_85 = param1;
         this.var_699 = new RoomObjectHightLighter(param1);
         this.var_148 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_235[param1])
         {
            ...
            this.var_699.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_56.furniLimit)
         {
            this.var_235[param1] = param2;
            this.var_699.show(param1);
         }
         this.refresh();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1086.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_148.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1086 = new SliderWindowController(this.var_85,IWindowContainer(this.find(this.var_86,"delay_slider_container")),this.var_85.assets,0,20,1);
         this.var_1086.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1086.setValue(0);
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1741);
         this.refreshConfigureElement(this.var_1740);
         this.refreshConfigureElement(this.var_1739);
