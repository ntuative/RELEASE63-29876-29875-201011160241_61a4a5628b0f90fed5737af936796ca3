package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_359.push(new ActorIsOnFurni());
         this.var_359.push(new FurnisHaveAvatars());
         this.var_359.push(new StatesMatch());
         this.var_359.push(new TimeElapsedMore());
         this.var_359.push(new TimeElapsedLess());
      }
