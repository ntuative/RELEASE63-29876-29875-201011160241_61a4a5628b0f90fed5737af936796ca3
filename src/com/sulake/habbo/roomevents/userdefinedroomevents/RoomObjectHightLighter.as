package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_85.roomEngine.getRoomObject(this.var_85.roomId,this.var_85.roomCategory,param1,RoomObjectCategoryEnum.const_28);
      }
