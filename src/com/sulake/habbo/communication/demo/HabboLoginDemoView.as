package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_506:String = "InitConnection";
      ...
      {
         Logger.log("Got ticket: " + this.var_159.ticket);
         this.var_160.shockwaveClientUrl = this.var_159.shockwaveClientUrl;
         this.var_160.ssoTicket = this.var_159.ticket;
         this.var_159.removeEventListener(SSOTicket.const_326,this.onParsedTicketSuccess);
         this.var_159.removeEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
         this.var_159 = null;
         dispatchEvent(new Event(const_506));
      }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1524,"/");
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_160.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_133,HabboWindowStyle.const_38,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1524,"/");
         if(_loc5_ != null)
         {
         ...
         {
            if(this.var_160.habboConfiguration.getKey("use.sso","HabboAvatarRenderLib_manifest") == "true")
            {
               _loc8_.select();
            }
         }
      ...
      private function initSSOTicket() : void
      {
         ...
         {
            _loc1_ = this.var_160.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = this.var_160.habboCommunication.habboWebLogin(this.name,this.password);
         this.var_159 = new SSOTicket(this.var_160.assets,_loc2_,_loc1_);
         this.var_159.addEventListener(SSOTicket.const_326,this.onParsedTicketSuccess);
         this.var_159.addEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
      }
