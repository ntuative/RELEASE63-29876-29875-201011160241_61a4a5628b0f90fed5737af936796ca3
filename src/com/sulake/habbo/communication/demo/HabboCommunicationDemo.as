package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private const const_1524:String = "fuselogin";
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_574 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1704 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2395 = this._habboConfiguration.getKey("external.variables.txt","");
         ...
         if(_loc3_)
         {
            this.var_43.mode = HabboConnectionType.const_109;
            if(this.var_574)
            {
               this.var_43.initConnection(HabboConnectionType.const_217);
            }
            else if(false)
            {
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_506,this.onInitConnection);
            }
         }
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2394)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1704,this.var_2395));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1524,"/");
      ...
      {
         var _loc4_:IConnection = this.var_43.getHabboMainConnection(null);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_466.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_466.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2396);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2396 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_43.mode)
         {
            case HabboConnectionType.const_109:
               _loc6_ = "";
               ...
               this.var_203.loadBannerImage(_loc7_ + "?token=" + this.var_1300,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1018:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1415:
               this.var_853 = this.generateRandomHexString(30);
               this.var_466 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_466.init(this.var_853);
               _loc8_ = this.var_466.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_43.mode);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_43 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_43.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_43.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_43.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_43.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_43.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_43.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_43.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
            this.var_43.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_43.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_43.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_43.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_43.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_43.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_43.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_43.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
      ...
      {
         if(this.var_43 && this._habboConfiguration && this.var_19 && this._windowManager)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_43.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_733);
            _loc3_ = new InitCryptoMessageComposer(this.var_43.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1300);
         ...
         var _loc9_:IConnection = this.var_43.getHabboMainConnection(null);
         ...
         this.var_466 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_466.init(_loc14_);
            _loc15_ = this.var_466.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_853 = _loc14_;
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_43.mode = HabboConnectionType.const_1018;
            }
         }
         this.var_43.initConnection(HabboConnectionType.const_217);
      }
