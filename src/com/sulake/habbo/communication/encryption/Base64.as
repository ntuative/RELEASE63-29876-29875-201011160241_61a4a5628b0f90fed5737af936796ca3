package com.sulake.habbo.communication.encryption
{
   ...
   public class Base64
   {
      ...
      public static const const_1094:uint = 76;
      
      private static const const_852:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
      ...
      public static function encodeBytes(param1:ByteArray, param2:uint = 76, param3:Boolean = true) : String
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         param2 = Math.min(param2,const_1094);
         var _loc4_:* = "";
         param1.position = 0;
         while(param1.bytesAvailable)
         {
            ...
            while(_loc10_ < _loc9_)
            {
               ...
               _loc4_ += const_852.charAt(_loc12_);
               _loc6_ -= 6;
               _loc10_++;
            }
            if(_loc7_ > 0 && param3)
      ...
      public static function decode(param1:String) : String
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            while(_loc7_ < 4)
            {
               ...
               _loc11_ = const_852.indexOf(_loc10_);
               if(_loc11_ > -1)
               {
