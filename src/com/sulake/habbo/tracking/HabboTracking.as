package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_839:uint = 11;
      
      private static var _instance:HabboTracking;
       
      
      private var var_560:FramerateTracker = null;
      ...
      private var var_559:LagWarningLogger = null;
      ...
      private var var_60:IRoomWidgetFactory;
      ...
      private var var_1019:IHabboWindowManager;
      ...
      private var var_178:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_226 = new PerformanceTracker();
         this.var_560 = new FramerateTracker();
         this.var_225 = new LatencyTracker();
         this.var_559 = new LagWarningLogger();
         this.var_561 = new ToolbarClickTracker(this);
         this.var_1266 = new Array(const_839);
         var _loc4_:int = 0;
         while(_loc4_ < const_839)
         {
            this.var_1266[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1313,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1369,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_655,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_935,String(0));
         }
      ...
      {
         this.var_60 = param2 as IRoomWidgetFactory;
         Component(this.var_60).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_60).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_60).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_60).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1019)
            {
               this.var_1019.release(new IIDHabboWindowManager());
               this.var_1019 = null;
            }
            if(this.var_273)
            {
            ...
            if(this.var_60)
            {
               this.var_60.release(new IIDHabboRoomWidget());
               this.var_60 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_178)
            {
               ...
               {
                  Component(this.var_178).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_178).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_178).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_178).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_178).events.removeEventListener(HabboFriendListTrackingEvent.const_348,this.onFriendlistTrackingEvent);
               }
               this.var_178.release(new IIDHabboFriendList());
               this.var_178 = null;
            }
            if(this.var_148)
            {
               if(!this.var_148.disposed)
               {
                  this.var_148.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_148.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_148.release(new IIDHabboHelp());
               this.var_148 = null;
            }
            if(this.var_132)
            {
               ...
               {
                  this.var_132.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
               }
      ...
      {
         this.var_1019 = IHabboWindowManager(param2);
         if(this.var_1019)
         {
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_571)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1390);
         }
         else if(param1.type == HabboHotelViewEvent.const_431)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1319);
         }
         else if(param1.type == HabboHotelViewEvent.const_69)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1272);
         }
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_132.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_157)
            {
               if(this.var_157.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_157.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1266)
                  {
                  ...
                  if(this.var_226 != null)
                  {
                     _loc4_["null"] = this.var_226.flashVersion;
                     _loc4_["null"] = this.var_226.averageUpdateInterval;
                  }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_273.events.addEventListener(AdEvent.const_390,this.onRoomAdLoad);
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_733:
               this.trackLoginStep(HabboLoginTrackingStep.const_1423,String(this._communication.port));
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_226 != null)
            {
               this.var_226.connection = param1;
            }
            if(this.var_225 != null)
            {
            ...
            {
               this.var_559.connection = param1;
            }
         }
      }
      ...
      {
         this.var_157 = IHabboConfigurationManager(param2);
         if(this.var_157)
         {
            if(this.var_225 != null)
            {
               this.var_225.configuration = this.var_157;
            }
            if(this.var_226 != null)
            {
               this.var_226.configuration = this.var_157;
            }
            ...
            if(this.var_157)
            {
               if(this.var_559 != null)
               {
                  this.var_559.configure(this.var_157);
               }
               if(this.var_560 != null)
               {
                  this.var_560.configure(this.var_157);
               }
               if(this.var_561 != null)
               {
                  this.var_561.configure(this.var_157);
               }
            }
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2294)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1311);
            this.var_2294 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_935,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_655,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_733,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_571,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_69,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_431,this.onHotelViewEvent);
      }
      ...
      {
         this.var_559.chatLagDetected();
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         this.var_148 = param2 as IHabboHelp;
         this.var_148.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_148.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_944);
         if(this._coreComponent != null)
         {
            this._coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_944,this.onCoreRunning);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(this.var_157 != null && !Boolean(this.var_157.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_1018 > -1 && _loc2_ < this.var_1018)
         {
            ++this.var_1623;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1623);
         }
         if(this.var_1018 > -1 && _loc2_ - this.var_1018 > 15000)
         {
            ++this.var_1622;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1622);
         }
         this.var_1018 = _loc2_;
         if(this.var_226 != null)
         {
            this.var_226.update(param1);
         }
         if(this.var_225 != null)
         {
            this.var_225.update(param1);
         }
         if(this.var_560 != null)
         {
            this.var_560.trackUpdate(param1,this);
         }
         if(this.var_559 != null)
         {
            this.var_559.update();
      ...
      {
         this.var_178 = param2 as IHabboFriendList;
         Component(this.var_178).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_178).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_178).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_178).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_178).events.addEventListener(HabboFriendListTrackingEvent.const_348,this.onFriendlistTrackingEvent);
      }
   }
}
