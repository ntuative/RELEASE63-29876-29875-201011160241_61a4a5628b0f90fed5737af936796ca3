package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_378:uint = 3;
      ...
      private var var_758:ISkinContainer;
      ...
      private var var_1175:ProfilerAgentTask;
      
      private var var_1173:IEventDispatcher;
      
      private var var_1174:ProfilerAgentTask;
      
      private var var_934:ProfilerOutput;
      
      private var var_759:IWindowRenderer;
      ...
      {
         return this.var_187[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return this.var_187[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_758 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_759 = new WindowRenderer(this.var_758);
         this.var_187 = new Array(const_378);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_378)
         {
            this.var_187[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_759,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_187[const_1126];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_339,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1289,_loc7_);
         unlock();
      ...
      {
         var _loc3_:IDesktopWindow = this.var_187[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            while(this.var_187.length > 0)
            {
               IDisposable(this.var_187.pop()).dispose();
            }
            this.var_187 = null;
      ...
      {
         return this.var_187[param1].getDesktopWindow().getChildAt(this._windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_934)
            {
               this.var_934 = new ProfilerOutput(context as CoreComponent,this,this.var_759);
            }
            this.var_934.profiler = _loc3_;
            this.var_1175 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1175);
            this.var_1174 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1174);
            this.var_935 = true;
         }
      }
      ...
      {
         return this.var_758.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_187[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_332.length > 0)
         {
            this.var_1173.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_378 - 1;
            while(_loc2_ >= 0)
            {
               this.var_187[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_935)
         ...
         this.var_1173.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_378)
         {
            this.var_187[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_935)
         {
         ...
         if(WindowContext.var_332.length > 0)
         {
            WindowContext.var_332.flush();
         }
         this.var_1173.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1467,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1350,param2.name + ": " + param2.toString());
            }
         }
      }
   }
