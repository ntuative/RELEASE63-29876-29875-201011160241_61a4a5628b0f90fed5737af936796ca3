package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1039:RoomLayout;
      ...
      private var var_1038:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_568 = new Timer(100);
         this.var_568.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_35 = new Array();
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,104,"a"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,94,"b"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,36,"c"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,84,"d"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"e"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"f"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,416,"i"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,320,"j"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,448,"k"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,352,"l"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,384,"m"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_52,372,"n"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_60,80,"g"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_60,74,"h"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_60,416,"o"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_60,352,"p"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_60,304,"q"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_60,336,"r"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_60,748,"u"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_60,438,"v"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_55,540,"t"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_55,512,"w"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_55,396,"x"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_55,440,"y"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_55,456,"z"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_55,208,"0"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_158.findChildByName("back_button"));
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_158 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_51 = IItemListWindow(this.var_158.findChildByName("item_list"));
         ...
         var _loc1_:IWindow = this.var_158.findChildByTag("close");
         _loc1_.procedure = this.onCancelButtonClick;
         this.var_1038 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_158.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_158.desktop,this.var_158.width,this.var_158.height);
         this.var_158.x = _loc2_.x;
         this.var_158.y = _loc2_.y;
      }
      ...
      {
         return IButtonWindow(this.var_158.findChildByName("create_button"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_568)
         {
            this.var_568.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_568.reset();
            this.var_568 = null;
         }
      }
      ...
      {
         this.var_1038.goBackToInitialState();
         this.var_1038.input.textBackgroundColor = 4294967295;
         this.var_1039 = this.var_35[0];
         this.refreshRoomThumbnails();
         this.refreshSelection();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_58,HabboWindowStyle.const_35,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_1038.getText();
         var _loc4_:String = "model_" + this.var_1039.name;
      ...
      {
         var _loc1_:Boolean = this.var_1038.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1039.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1661 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1661 = true;
            _loc3_.y = 1;
