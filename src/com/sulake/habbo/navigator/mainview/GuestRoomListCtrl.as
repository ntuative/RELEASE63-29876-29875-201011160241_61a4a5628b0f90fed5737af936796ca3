package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_443:RoomPopupCtrl;
      
      private var var_2260:int;
      
      private var var_489:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_443 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1241.tags[0];
            this.var_1241.color = this.getBgColor(_loc2_);
         }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_489 = IScrollbarWindow(this.var_158.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(this.var_2260 - _loc2_.stageX);
         this.var_2260 = _loc2_.stageX;
         this.var_2261 = _loc3_ > 2;
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_489.scrollV = 0;
         }
         this.var_158.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_167,null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_182)
         {
            this.checkFastHorizontalMove(param1);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(this.var_443.visible && this.var_2261)
            {
               return;
            }
            ...
            this.var_443.room = _loc4_;
            this.var_443.showPopup(param2);
         }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1376,true);
