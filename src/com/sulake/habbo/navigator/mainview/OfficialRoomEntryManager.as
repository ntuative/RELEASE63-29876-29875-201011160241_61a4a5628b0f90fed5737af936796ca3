package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1116:int = 65;
      
      private static const const_1115:int = -70;
       
      
      private var var_1915:PublicRoomThumbs;
      ...
      {
         this.var_1915 = new PublicRoomThumbs();
         super();
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1352)
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1116) : int(const_1117);
         this.refreshPicText(_loc3_,param2);
         this.method_9(_loc3_,param2);
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_211,Tabs.const_361,_loc2_.tag);
         }
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_644 || param2.type == OfficialRoomEntryData.const_732))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function method_9(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
      ...
      {
         var _loc4_:String = this.var_1915.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1115) : 0;
