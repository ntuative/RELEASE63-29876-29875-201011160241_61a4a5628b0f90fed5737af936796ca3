package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_325);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_596);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_325,"" + _loc3_);
         }
      }
