package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1467:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_211,Tabs.const_199,"-1",MainViewCtrl.const_701);
      }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_361)
            {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1467 == null)
         {
            ...
            this.var_1467 = new TextSearchInputs(this._navigator,false,_loc4_);
            this.initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(this._navigator.data.guestRoomSearchArrived && this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_199)
         {
            this.var_1467.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
