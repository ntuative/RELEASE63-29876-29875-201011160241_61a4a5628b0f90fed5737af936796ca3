package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_502:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_340:Tabs;
      
      private var var_251:MainViewCtrl;
      
      private var var_1877:Array;
      
      private var var_855:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_251 = new MainViewCtrl(this);
         this.var_502 = new RoomInfoViewCtrl(this);
         this.var_921 = new RoomCreateViewCtrl(this);
         this.var_1878 = new RoomThumbnailRenderer(this);
         this.var_855 = new GuestRoomPasswordInput(this);
         this.var_297 = new GuestRoomDoorbell(this);
         this.var_340 = new Tabs(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_251.startSearch(Tabs.const_211,Tabs.const_361,param1);
         this.var_251.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && this.var_132 != null)
         {
            this.var_132.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_157.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_132.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_132.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_286,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.setHabboToolbarIcon();
         this.var_502.registerToolbarEvents();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_251.startSearch(Tabs.const_256,Tabs.const_250);
         this.var_340.getTab(Tabs.const_256).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = this.var_251.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
