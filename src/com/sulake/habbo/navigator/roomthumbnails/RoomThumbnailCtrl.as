package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2460:IWindowContainer;
      
      private var _window:IWindowContainer;
      
      private var var_1751:IButtonWindow;
      ...
      private var var_1752:IButtonWindow;
      
      private var var_2461:IWindowContainer;
      ...
      {
         this.setEnabled(this.var_1750,this.var_62.mode != ThumbnailEditorModel.const_36);
         this.setEnabled(this.var_1752,this.var_62.mode != ThumbnailEditorModel.const_56);
         this.setEnabled(this.var_1751,this.var_62.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1750 = IButtonWindow(this.find("bg_tab"));
         this.var_1752 = IButtonWindow(this.find("top_tab"));
         this.var_1751 = IButtonWindow(this.find("obj_tab"));
         this.var_2461 = IWindowContainer(this.find("tile_grid"));
         this.var_2460 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1750,this.onBgTabButton);
         Util.setProcDirectly(this.var_1752,this.onTopTabButton);
         Util.setProcDirectly(this.var_1751,this.onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2461;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_524)
            {
      ...
      {
         var _loc1_:IWindowContainer = this.var_2460;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_58,HabboWindowStyle.const_35,HabboWindowParam.const_63,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_286,HabboWindowStyle.const_38,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
