package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_824:int = 32;
      
      private static const const_1148:int = 8;
      
      public static const const_524:int = 10;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_793 = new ThumbnailImageConfigurations(this._navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_286,HabboWindowStyle.const_38,0 | (!!param3 ? HabboWindowParam.const_37 : HabboWindowParam.const_38),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_793.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1149,_loc4_.y + const_1147 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2153[param1]);
      }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_793.getImage(ThumbnailEditorModel.const_56,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_824 / 2);
         return new Point(param1 * const_824 + _loc3_,param2 * const_1148);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1220 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1220,this.var_1220.rect,new Point(0,0),null,null,true);
      }
   }
}
