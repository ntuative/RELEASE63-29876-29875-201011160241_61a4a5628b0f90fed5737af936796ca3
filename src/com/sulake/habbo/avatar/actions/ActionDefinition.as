package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_359 = new Dictionary();
         this.var_1412 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_1903 = parseInt(param1.@precedence);
         this.var_1900 = String(param1.@activepartset);
         this.var_1907 = String(param1.@assetpartdefinition);
         this.var_1902 = String(param1.@lay);
         this.var_663 = String(param1.@geometrytype);
         this.var_1905 = Boolean(parseInt(param1.@main));
         this.var_1901 = Boolean(parseInt(param1.@method_4));
         this.var_1906 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_1904 = _loc6_;
            }
            else
            {
               this.var_1412[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_359[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_607.add(param1,new Map());
         }
         var _loc4_:Map = this.var_607.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_607.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getPreventHeadTurn(param1:String = "") : Boolean
      {
         ...
         var _loc2_:ActionType = this.var_359[param1];
         if(_loc2_ != null)
         {
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1412[param1];
         if(_loc2_ == null)
         {
