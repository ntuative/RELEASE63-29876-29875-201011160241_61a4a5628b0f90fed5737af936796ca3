   ...
   public class CategoryBaseView
   {
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_1824);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_33[this.var_127];
         if(_loc2_ == null)
         {
            return;
         }
