package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_763 >= 0 && this._parts.length > this.var_763)
         {
            _loc2_ = this._parts[this.var_763];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_188 || this.var_188.length == 0)
         {
            return null;
         }
         if(!this.var_212 || this.var_212.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_212[0] as Array;
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_188.length)
         {
            _loc7_ = this.var_212[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_188[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_188[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_188[param2],param2);
         this.var_188[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_188[param1])
         {
            return null;
         }
         return _loc2_[this.var_188[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_212.length <= param1)
         {
            return null;
         }
         return this.var_212[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_763] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_212)
         {
            for each(_loc2_ in this.var_212 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_188 = new Array(param1.length);
         var _loc3_:int = 0;
