package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public function hasClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         for each(_loc3_ in this.var_88)
         {
            if(_loc3_)
            {
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = this.var_88.getKeys();
         var _loc3_:Boolean = false;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            _loc5_ = _loc2_[_loc4_];
            _loc6_ = this.var_88[_loc5_];
            _loc7_ = false;
      ...
      {
         if(!this.var_88 || !this._controller || !this._controller.figureData)
         {
            return;
         }
         var _loc2_:CategoryData = this.var_88[param1];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc4_:CategoryData = this.var_88[param1];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:CategoryData = this.var_88[param1];
         if(_loc3_ == null)
         {
            return;
         }
