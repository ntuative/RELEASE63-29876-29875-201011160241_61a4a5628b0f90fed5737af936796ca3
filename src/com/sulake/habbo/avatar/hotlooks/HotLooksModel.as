package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1548:String = "hot_looks";
      
      public static const const_1686:String = "my_looks";
      ...
      {
         super(param1);
         this.var_404 = new Dictionary();
         this.var_404["null"] = new Array();
         this.var_404["null"] = new Array();
         this.var_404["undefined.index"] = 0;
         this.var_404["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_404["null"];
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_404[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
