package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_512.getGridItemIndex(param2.parent);
      ...
      public function init() : void
      {
         ...
         this.var_512 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_512.numGridItems > 0)
         {
            this.var_512.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_62 = null;
