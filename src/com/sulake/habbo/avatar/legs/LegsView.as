   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_195,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_245,_windowManager,_assetLibrary);
         }
         else
         {
