package com.sulake.habbo.avatar.palette
{
   ...
   public class PaletteMap
   {
      ...
      {
         param1.paletteMap(param1,param1.rect,new Point(0,0),this._blank,this.var_528,this._blank,this._blank);
      }
      ...
      public function colorize(param1:ByteArray) : ByteArray
      {
         ...
         while(param1.bytesAvailable >= 4)
         {
            ...
            _loc7_ = uint(this.var_528[_loc5_] as uint);
      ...
      {
         var _loc2_:int = this.var_528.indexOf(param1);
