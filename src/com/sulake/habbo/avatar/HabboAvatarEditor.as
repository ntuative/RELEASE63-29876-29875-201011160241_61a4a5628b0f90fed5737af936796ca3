package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_986:AvatarEditorHandler;
      ...
      private var var_840:String = "M";
      
      private var var_1564:Boolean;
      
      private var var_1235:IHabboAvatarEditorDataSaver = null;
      ...
      private var var_797:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_797.getSetType(param1);
      }
      ...
      public function update() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_88)
         {
            _loc1_.reset();
         }
      ...
      private function init() : void
      {
         ...
         if(!this.var_171)
         {
            ...
            this.var_546["null"] = new FigureData(this);
            this.var_546["null"] = new FigureData(this);
            _loc1_ = this.var_546["null"];
            _loc2_ = this.var_546["null"];
            _loc1_.loadAvatarData(const_1162,FigureData.const_81);
            _loc2_.loadAvatarData(const_1163,FigureData.FEMALE);
            this.var_88 = new Map();
            this.var_440 = new Map();
            this.var_88.add(AvatarEditorFigureCategory.const_676,new BodyModel(this));
            this.var_88.add(AvatarEditorFigureCategory.const_42,new HeadModel(this));
            this.var_88.add(AvatarEditorFigureCategory.const_238,new TorsoModel(this));
            this.var_88.add(AvatarEditorFigureCategory.const_573,new LegsModel(this));
            this.var_88.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            this.var_440.add(AvatarEditorSideCategory.const_95,new WardrobeModel(this));
            this.var_440.add(AvatarEditorSideCategory.const_396,new ClubPromoModel(this));
            this.var_171 = true;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_840 == param1)
         {
            return;
         }
         this.var_840 = param1;
         for each(_loc2_ in this.var_88)
         {
            _loc2_.reset();
         }
         if(this._view != null)
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1235 != null)
         {
            ...
            this.var_1235.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_985 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      {
         return this.var_546[this.var_840];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1564;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_985 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1164)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1382.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_439.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_439.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1131.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1327)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_985 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1131.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_440.getValue(AvatarEditorSideCategory.const_95);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_986 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_797.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_440.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this._windowContext == null)
            {
               this._windowContext = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_58,HabboWindowStyle.const_35,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_676);
         }
      ...
      {
         this.var_797 = this.var_439.getFigureData(AvatarType.const_115);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_439 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_88.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         this.var_985 = param3;
         var _loc4_:FigureData = this.var_546[param2];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_88)
         {
            for each(_loc5_ in this.var_88)
            {
               _loc5_.reset();
            }
         }
