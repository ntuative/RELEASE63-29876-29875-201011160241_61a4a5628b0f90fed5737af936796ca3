package com.sulake.habbo.avatar.geometry
{
   public class GeometryItem extends Node3D
   {
      ...
      public function GeometryItem(param1:XML, param2:Boolean = false)
      {
         ...
         this.var_1171 = parseFloat(param1.@radius);
         this.var_505 = new Vector3D(parseFloat(param1.@nx),parseFloat(param1.@ny),parseFloat(param1.@nz));
         this.var_2380 = parseInt(param1.@double) as Boolean;
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - this.var_1171);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + this.var_1171);
