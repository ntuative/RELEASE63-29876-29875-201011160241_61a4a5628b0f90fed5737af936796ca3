package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = this.var_163 * param1.z - this.var_162 * param1.y;
         _loc2_.y = this.var_162 * param1.x - this._x * param1.z;
         _loc2_.z = this._x * param1.y - this.var_163 * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(this._x * this._x + this.var_163 * this.var_163 + this.var_162 * this.var_162);
      }
      ...
      {
         return this._x * param1.x + this.var_163 * param1.y + this.var_162 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + this._x + "," + this.var_163 + "," + this.var_162 + ")";
      }
