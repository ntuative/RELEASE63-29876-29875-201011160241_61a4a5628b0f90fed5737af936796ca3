package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_808 = new Vector3D(0,0,10);
         super();
         this.var_993 = new Matrix4x4();
         this.var_652 = new Dictionary();
         this.var_1579 = new Dictionary();
         this.var_1580 = new AvatarSet(param1.avatarset[0]);
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_808.x = _loc11_;
            this.var_808.y = _loc12_;
            this.var_808.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_652[String(_loc6_.@id)] = _loc7_;
            this.var_1579[String(_loc6_.@id)] = _loc8_;
         }
      }
      
      public function isMainAvatarSet(param1:String) : Boolean
      {
         var _loc2_:AvatarSet = this.var_1580.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1579[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1580.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_993 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_993);
            _loc9_ = _loc7_.getDistance(this.var_808);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_993 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_993,this.var_808,param4);
         }
         return [];
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_652[param1] as Dictionary;
      ...
      {
         return this.var_652[param1] != null;
      }
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_652[param1] as Dictionary;
         }
