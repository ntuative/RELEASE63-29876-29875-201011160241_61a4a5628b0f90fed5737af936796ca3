package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_560:String = "bodypart";
      
      public static const const_422:String = "fx";
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         this.var_2341 = parseInt(param2.@frame);
         this._dx = parseInt(param2.@dx);
         this.var_1296 = parseInt(param2.@dy);
         this.var_1295 = parseInt(param2.@dz);
         this.var_1454 = parseInt(param2.@dd);
         this._type = param3;
         this.var_1031 = String(param2.@base);
      ...
      private function baseAsInt() : int
      {
         ...
         {
            _loc1_ += this.var_1031.charCodeAt(_loc2_);
            _loc2_++;
         }
         return _loc1_;
      }
