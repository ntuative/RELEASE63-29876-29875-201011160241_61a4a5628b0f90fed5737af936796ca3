package com.sulake.habbo.avatar.alias
{
   ...
   public class AssetAliasCollection
   {
      ...
      private var var_439:AvatarRenderManager;
      ...
      public function getAssetByName(param1:String) : IAsset
      {
         ...
         {
            _loc4_ = this.var_586[param1] as AssetAlias;
            param1 = _loc4_.link;
            _loc2_--;
         }
         ...
         if(_loc3_ == null)
         {
            this.var_439.events.dispatchEvent(new AvatarRenderAssetErrorEvent(param1));
         }
         return _loc3_;
      }
      ...
      public function addAlias(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         this.var_586[param1] = _loc6_;
      }
      
      public function getAliasByName(param1:String) : AssetAlias
      {
         return this.var_586[param1] as AssetAlias;
      }
      
      public function hasAlias(param1:String) : Boolean
      {
         var _loc2_:AssetAlias = this.var_586[param1] as AssetAlias;
         return _loc2_ != null;
      }
   }
}
