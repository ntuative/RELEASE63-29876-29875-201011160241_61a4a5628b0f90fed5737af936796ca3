package com.sulake.habbo.avatar.structure
{
   ...
   public class FigureData implements IStructureData, IFigureData
   {
      ...
      private var var_212:Dictionary;
      
      public function FigureData()
      {
         super();
         this.var_212 = new Dictionary();
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            this.var_212[String(_loc2_.@id)] = new Palette(_loc2_);
         }
         for each(_loc3_ in param1.sets.settype)
         {
            this.var_416[String(_loc3_.@type)] = new SetType(_loc3_);
         }
         return true;
      }
      ...
      {
         return this.var_212[String(param1)];
      }
      ...
      public function injectXML(param1:XML) : void
      {
         ...
         {
            _loc3_ = this.var_416[String(_loc2_.@type)];
            if(_loc3_ != null)
            {
            ...
            {
               this.var_416[String(_loc2_.@type)] = new SetType(_loc2_);
            }
         }
      ...
      {
         var _loc3_:SetType = this.var_416[param1] as SetType;
         if(_loc3_)
         {
      ...
      public function appendXML(param1:XML) : Boolean
      {
         ...
         for each(_loc2_ in param1.colors.palette)
         {
            _loc4_ = this.var_212[String(_loc2_.@id)];
            if(_loc4_ == null)
            {
               this.var_212[String(_loc2_.@id)] = new Palette(_loc2_);
            }
         ...
         for each(_loc3_ in param1.sets.settype)
         {
            _loc5_ = this.var_416[String(_loc3_.@type)];
            if(_loc5_ == null)
            {
               this.var_416[String(_loc3_.@type)] = new SetType(_loc3_);
            }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         for each(_loc4_ in this.var_416)
         {
