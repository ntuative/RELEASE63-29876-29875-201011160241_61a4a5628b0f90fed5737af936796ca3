package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1585:PartOffsetData;
      
      private var var_810:AvatarActionManager;
      
      private var var_361:AvatarRenderManager;
      ...
      private var var_765:ActionDefinition;
      ...
      {
         return this.var_810.getActionDefinitionWithState(param1);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_810.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_445);
            return false;
         }
         if(this.var_446.parse(param1))
         {
            if(this.var_445 == AvatarType.const_115)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1453[param3];
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_445);
            return;
         }
      ...
      {
         return this.var_810.getActionDefinition(param1);
      }
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_445);
            return false;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_445);
            return;
         }
         this.var_810 = new AvatarActionManager(param1,this.var_445,param2);
         this.var_765 = this.var_810.getDefaultAction();
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_445);
            return false;
         }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         this.var_655[param1][param2] = this.var_362.getMandatorySetTypeIds(param1,param2);
         return this.var_655[param1][param2];
      }
      ...
      {
         return this.var_1585.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      {
         this.var_1585.loadOffsets(param1);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return this.var_810.sortActions(param1);
      }
   }
}
