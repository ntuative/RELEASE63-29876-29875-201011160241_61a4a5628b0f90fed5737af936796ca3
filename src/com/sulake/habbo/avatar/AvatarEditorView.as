package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1131:IWindowContainer;
      
      public static var var_1824:int = 6710886;
      ...
      private var var_406:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_405:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_929 = [];
         this.var_1169 = [AvatarEditorFigureCategory.const_676,AvatarEditorFigureCategory.const_42,AvatarEditorFigureCategory.const_238,AvatarEditorFigureCategory.const_573,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_95];
         super();
         ...
         if(var_1131 == null)
         {
            ...
            var_1131 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1382 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1382 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_343 = new Timer(1000);
         this.var_343.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1169;
         }
         for each(_loc6_ in param4)
         {
            this.var_929.push(_loc6_);
         }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1426 == AvatarEditorSideCategory.const_95 || this.var_1961))
         {
         ...
         this.setViewToCategory(this.var_289);
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1169;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_343.stop();
            this.var_343.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_343 = null;
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_405)
         {
            ...
            this.var_405 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_405.procedure = this.stripClubDialogEventProc;
            this.var_405.center();
         }
         else
         {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_406 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_406.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_406.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_929.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_406.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_406.numSelectables)
               {
                  this.var_406.getSelectableAt(_loc6_).x = this.var_406.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1169);
         }
         if(param1.length != this.var_929.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_929.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_1960 = this.canChangeOutfit();
            this.var_343.stop();
            if(this._window)
            {
      ...
      {
         if(this.var_1426 == AvatarEditorSideCategory.const_95)
         {
            this.var_1961 = false;
            this.setSideContent(AvatarEditorSideCategory.const_738);
         }
         else
         {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_289 = param1;
         this.var_406.setSelected(this.var_406.getSelectableByName(param1));
