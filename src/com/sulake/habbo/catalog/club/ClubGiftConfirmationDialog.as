package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this._controller.confirmSelection(this.var_79.localizationId);
               break;
      ...
      public function showConfirmation() : void
      {
         ...
         if(!this.var_79.productContainer)
         {
            return;
         }
         this.var_79.productContainer.view = _loc2_;
         this.var_79.productContainer.initProductIcon(this._controller.roomEngine);
      }
