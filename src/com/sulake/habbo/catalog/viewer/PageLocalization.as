package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_156:Dictionary = new Dictionary();
      
      private static const const_806:Object = {"frontpage3":[7,8]};
      
      private static const const_1114:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_807:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      private static const const_1113:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      
      {
         const_156["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_156["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_156["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_156["collectibles"] = ["ctlg_collectibles_link"];
         const_156["club1"] = ["ctlg_text_5"];
         const_156["club_buy"] = ["club_link"];
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_609.length)
         {
            _loc2_ = String(this.var_609[param1]).replace("#","0x");
