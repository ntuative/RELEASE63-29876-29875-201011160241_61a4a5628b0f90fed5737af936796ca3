package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1291:MarketPlaceOfferData;
      
      private const const_1499:int = 1;
      
      private const const_1782:int = 40;
      
      private var var_571:IWindowContainer;
      
      private const const_1498:int = 2;
      ...
      private const const_1783:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_571)
         {
            ...
            this.var_571 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_571)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1498,_loc2_.length);
         if(!this.var_462)
         {
            this.var_462 = new Timer(25);
            this.var_462.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1044 = 0;
         this.populateList();
         this.var_462.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_571 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_571.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1499);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_462)
         {
            this.var_462.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_462 = null;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1291.offerId);
            }
            return;
         }
