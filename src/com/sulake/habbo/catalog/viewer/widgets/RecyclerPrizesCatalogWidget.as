package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1101:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_705.length)
         {
            this.createLevelItem(this.var_705[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         this.var_1101 = new PrizeViewer();
         this.var_705 = this.recycler.getPrizeTable();
         ...
         this.var_1761 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_705.length > 0 && this.var_705[0].prizes.length > 0)
         {
            this.select(this.var_705[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1761) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1762) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1101.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
