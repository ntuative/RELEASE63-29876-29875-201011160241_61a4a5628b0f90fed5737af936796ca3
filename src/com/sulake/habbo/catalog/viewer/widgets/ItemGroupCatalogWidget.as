package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = this.var_592[this.var_1106] as Array;
      ...
      {
         var _loc2_:Offer = this.var_592[this.var_1106][this.var_1778];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_501 || _loc1_.pricingModel == Offer.const_486)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_77 || _loc3_.productType == ProductTypeEnum.const_86)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_592.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_592[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1778 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1778] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1106 = var_1147.getGridItemIndex(param1.view);
