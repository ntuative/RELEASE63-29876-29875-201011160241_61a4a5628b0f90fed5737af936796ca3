package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1575 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1242.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_300 = null;
         for each(_loc1_ in this.var_1242)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1575) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_897.width,this.var_897.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_897,this.var_897.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_897 = _loc4_.content as BitmapData;
