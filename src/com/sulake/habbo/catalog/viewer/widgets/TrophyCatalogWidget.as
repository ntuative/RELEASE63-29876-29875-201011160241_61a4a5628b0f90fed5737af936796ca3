package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_252 < 0)
         {
            this.var_252 = this.var_345.length - 1;
         }
         var _loc2_:Map = this.var_345.getWithIndex(this.var_252);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_618);
            if(_loc3_ == null)
            {
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_345.getValue(_loc5_) == null)
            {
               this.var_345.add(_loc5_,new Map());
            }
            _loc7_ = this.var_345.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_345.getWithIndex(this.var_252);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_618);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_252;
         if(this.var_252 >= this.var_345.length)
         {
            this.var_252 = 0;
         }
         var _loc2_:Map = this.var_345.getWithIndex(this.var_252);
