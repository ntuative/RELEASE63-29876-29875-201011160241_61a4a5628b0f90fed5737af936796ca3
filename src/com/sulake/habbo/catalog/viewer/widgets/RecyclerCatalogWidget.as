      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               if(this.var_257 != null)
               {
                  this.var_257.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_257 == null)
               {
                  this.var_257 = new CatalogObjectMover();
                  this.var_257.mainContainer = window;
                  this.var_257.roomEngine = _loc3_;
               }
               this.var_257.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
