package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_675:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         this.var_1147 = _window.findChildByName("botGrid") as IItemGridWindow;
         this.var_1645 = new Map();
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1645.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            if(_loc3_.offerId == _loc2_ && _loc3_.productContainer && _loc3_.productContainer.view && !_loc3_.productContainer.view.disposed)
            {
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_675.offerId == _loc2_)
                  {
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1645.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1273.getValue(this.var_675.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_675,page.pageId);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc1_.registerParameter(_loc5_,"credits",String(this.var_675.priceInCredits));
            _loc1_.registerParameter(_loc5_,"pixels",String(this.var_675.priceInActivityPoints));
            _loc2_.text = _loc1_.getKey(_loc5_);
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_675.localizationId);
