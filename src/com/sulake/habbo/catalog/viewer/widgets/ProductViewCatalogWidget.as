package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1292:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_463 != null)
         {
            ...
            this.var_463.destroyGridItems();
         }
         if(this.var_1292 != null)
         {
            this.var_1292.visible = false;
         }
         ...
         this.var_847.text = _loc4_;
         this.var_1045.text = _loc5_;
         this.var_847.height = this.var_847.textHeight + 5;
         this.var_1045.y = this.var_847.y + this.var_847.height;
         this.var_1045.height = Math.max(130,this.var_1045.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_454:
                  _loc6_ = this.var_1677.clone();
                  if(this.var_463 != null)
                  {
                     this.var_463.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_463,this.var_1292,this.var_1762);
                     this.var_463.scrollV = 0;
                  }
                  break;
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_210:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_51);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_42,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_292,AvatarAction.const_480);
                              _loc16_.appendAction(AvatarAction.const_267,_loc8_.productClassId);
      ...
      {
         this.var_847 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1045 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_80 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1676 = new Point(this.var_80.x,this.var_80.y);
         this.var_463 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1292 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_463 == null)
         {
         ...
         this.var_1677 = _loc2_.content as BitmapData;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2361)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_80 != null && true)
         {
            ...
            this.var_80.x = this.var_1676.x;
            this.var_80.y = this.var_1676.y;
            if(param3 != null)
            {
