package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function MarketplaceChart(param1:Array, param2:Array)
      {
         ...
         this.var_163 = param2.slice();
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_942 + this.var_942 / -this.var_2586 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_767 - this.var_767 / this.var_510 * this.var_163[param1];
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_510 = 0;
         for each(_loc4_ in this.var_163)
         {
            if(_loc4_ > this.var_510)
            {
               this.var_510 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_510).toString().length - 1);
         this.var_510 = Math.ceil(this.var_510 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_510.toString();
         _loc3_.draw(_loc6_);
         this.var_942 = param1 - _loc6_.textWidth - 2;
         this.var_767 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_767);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_767 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_942 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_942,(param2 - this.var_767) / 2));
         return _loc3_;
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_163 && this._x.length > 1;
      }
   }
}
