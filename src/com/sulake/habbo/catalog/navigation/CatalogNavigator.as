package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2605:String = "magic.pixels";
      
      private var var_2606:String = "catalog.page.club";
      
      private var var_2641:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = this._catalog.configuration.getKey("client.credits.embed.enabled","HabboAvatarRenderLib_manifest") == "true";
         if(false && _loc1_)
         {
      ...
      {
         this.openPage(this.var_2605);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2606,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_305.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_305)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_305.indexOf(_loc6_);
            this.var_305.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_305.indexOf(param1) == -1)
         {
      ...
      private function openNavigatorAtNode(param1:ICatalogNode) : void
      {
         ...
         for each(_loc2_ in this.var_305)
         {
            _loc2_.deActivate();
            _loc2_.close();
         }
