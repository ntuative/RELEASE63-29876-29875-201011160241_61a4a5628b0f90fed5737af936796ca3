package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1106:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1155:XML;
      
      private static var var_1157:XML;
       
      
      private var var_2583:IWindowContainer;
      ...
      private var var_1396:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1396 == 4294967295)
            {
               this.var_1396 = _loc1_.color;
            }
            _loc1_.color = const_1106;
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1155) as IWindowContainer;
         }
         else
         {
      ...
      {
         this.var_51 = navigator.catalog.windowManager.buildFromXML(var_1157) as IItemListWindow;
         if(this.var_51 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1239;
            }
         }
      }
