package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_256:IBitmapWrapperWindow;
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_256 != null && !this.var_256.disposed)
         {
            ...
            this.var_256.bitmap = new BitmapData(this.var_256.width,this.var_256.height,true,16777215);
            this.var_256.bitmap.fillRect(this.var_256.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_256.width - param1.width) / 2,(this.var_256.height - param1.height) / 2);
            this.var_256.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
      ...
      {
         var _loc8_:* = null;
         this.var_256 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
