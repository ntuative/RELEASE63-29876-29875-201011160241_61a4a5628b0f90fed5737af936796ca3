package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1510:IMessageComposer;
      ...
      {
         this.var_943 = IWindowContainer(this.var_45.getXmlWindow("chatlog_roomheader"));
         this.var_944 = IWindowContainer(this.var_45.getXmlWindow("chatlog_chatline"));
         ...
         this.var_45.connection.send(this.var_1510);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_943.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_944.clone());
         _loc4_.color = this.var_1457[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
