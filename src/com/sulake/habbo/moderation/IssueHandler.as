package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_461:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.releaseBundle(this.var_119.id);
      ...
      private function createView() : void
      {
         ...
         this.var_461 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
         this.var_1043 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
         this.var_461.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_119.getHighestPriorityIssue().reporterUserId);
         ...
         {
            this.var_1043.load(_loc4_,this.var_119.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_119.id,1);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_59,WindowTracker.const_1034,_loc2_),this._window,false,false,true);
      }
      ...
      {
         if(this.var_59 != null && this.var_59.issueManager != null && this.var_119 != null)
         {
            this.var_59.issueManager.removeHandler(this.var_119.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_461 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
            this.var_461.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_119.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_119.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
