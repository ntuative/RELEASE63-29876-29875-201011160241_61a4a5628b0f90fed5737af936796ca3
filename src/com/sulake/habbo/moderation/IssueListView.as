package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2633:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_529 = param2;
         this.var_51 = param3;
         this.var_1452 = param4;
         this.var_1456 = this.var_529.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || this.var_1456 == null)
            {
               return;
            }
            _loc2_ = this.var_1456.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = this.var_529.assets.getAssetByName(_loc8_) as BitmapDataAsset;
