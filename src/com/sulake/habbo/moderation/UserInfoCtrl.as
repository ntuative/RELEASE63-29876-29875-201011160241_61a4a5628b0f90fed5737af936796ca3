package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_844:int = 31536000;
      
      private static const const_843:int = 86400;
      
      private static const const_846:int = 3600;
      
      private static const const_845:int = 60;
      ...
      {
         if(param1 < 2 * const_845)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_846)
         {
            return Math.round(param1 / const_845) + " mins ago";
         }
         if(param1 < 2 * const_843)
         {
            return Math.round(param1 / const_846) + " hours ago";
         }
         if(param1 < 2 * const_844)
         {
            return Math.round(param1 / const_843) + " days ago";
         }
         return Math.round(param1 / const_844) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_45,WindowTracker.const_1079,this._data.userId),this._callerFrame,this.var_1033,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1032.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_45.getXmlWindow("user_info"));
            this.var_1032.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ModActionCtrl(this.var_45,this._data.userId,this._data.userName,this.var_1256),this._callerFrame,this.var_1033,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new RoomVisitsCtrl(this.var_45,this._data.userId),this._callerFrame,this.var_1033,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new SendMsgsCtrl(this.var_45,this._data.userId,this._data.userName,this.var_1256),this._callerFrame,this.var_1033,false,true);
      }
