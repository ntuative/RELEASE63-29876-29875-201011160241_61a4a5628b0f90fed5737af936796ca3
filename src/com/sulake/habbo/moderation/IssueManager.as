package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1061:String = "issue_bundle_open";
      
      public static const const_784:String = "issue_bundle_my";
      ...
      private var var_529:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_529 = new IssueBrowser(this,this.var_59.windowManager,this.var_59.assets);
         this.var_973 = [];
         this.var_972 = [];
      ...
      {
         var _loc2_:IssueHandler = this.var_633.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in this.var_92)
         {
            switch(param1)
            {
               case const_1061:
                  ...
                  break;
               case const_784:
                  if(_loc4_.state == IssueMessageData.const_311 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_790.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_790.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1357)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_92)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_790.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2118++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_790.add(param1.issueId,_loc2_);
         ...
         if(this.var_973.indexOf(param1.issueId) != -1)
         {
            ...
            {
               if(param1.state == IssueMessageData.const_311)
               {
         ...
         {
            _loc6_ = this.getBundles(const_784);
            _loc7_ = false;
            ...
            _loc9_ = this.var_972.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_633.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_633.remove(param1);
         this.var_633.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_311 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_972 = this.var_972.concat(param1);
      }
      ...
      {
         var _loc2_:* = this.var_633.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_633.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_151 && (_loc4_ == null || _loc5_.getPrioritySum() > _loc4_.getPrioritySum()))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_529 == null || !this.var_529.isOpen())
         {
            this.var_59.soundManager.playSound(HabboSoundTypesEnum.const_912);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_790.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_92.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_311 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
