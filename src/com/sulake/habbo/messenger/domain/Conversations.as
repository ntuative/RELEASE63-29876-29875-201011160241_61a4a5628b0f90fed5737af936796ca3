package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_570,0,this.var_378.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = this.var_378.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_121.length - this.var_378.getTabCount());
      ...
      {
         return this.var_378.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(this._startIndex + this.var_378.getTabCount() <= _loc2_)
         {
            ++this._startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         this.var_378.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_714,0,this.getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         this.var_378.addMsgToView(_loc3_,param1);
