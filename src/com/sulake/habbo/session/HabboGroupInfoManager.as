package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = this.var_221.getValue(_loc2_.groupId);
         this.var_1193[_loc2_.groupId] = _loc3_;
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(this.var_221.getValue(_loc4_) != null)
            {
               this.var_221.remove(_loc4_);
            }
            this.var_221.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      {
         return this.var_221.getValue(param1);
      }
      ...
      {
         var _loc2_:HabboGroupDetails = this.var_1193[param1];
         if(_loc2_ == null)
         {
