package com.sulake.habbo.session.product
{
   ...
   public class ProductDataParser extends EventDispatcher
   {
      ...
      public function ProductDataParser(param1:String, param2:Dictionary)
      {
         super();
         this.var_923 = param2;
         this.var_653 = new AssetLibrary("ProductDataParserAssetLib");
         var _loc3_:AssetLoaderStruct = this.var_653.loadAssetFromFile(param1,new URLRequest(param1),"text/plain");
