package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1223:int = 2;
      ...
      public function removeUserDataByIndex(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_724.getValue(_loc2_.type);
            if(_loc3_ != null)
            {
      ...
      {
         return this.getUserDataByType(param1,const_1224);
      }
      ...
      public function setUserData(param1:IUserData) : void
      {
         ...
         trace("setUserData id = " + param1.id + " webID = " + param1.webID + " type = " + param1.type);
         this.removeUserDataByIndex(param1.id);
         var _loc2_:Map = this.var_724.getValue(param1.type);
         if(_loc2_ == null)
         {
            _loc2_ = new Map();
            this.var_724.add(param1.type,_loc2_);
         }
      ...
      {
         var _loc3_:* = null;
         var _loc4_:Map = this.var_724.getValue(param2);
         if(_loc4_ != null)
         {
      ...
      {
         return this.getUserDataByType(param1,const_1223);
      }
