package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1797:String = "type_sound_machine";
      
      private var var_269:int = -1;
      
      private var var_1756:String = "";
      
      private const const_1534:String = "type_jukebox";
      ...
      private var var_573:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_703,this.onSongFinishedPlayingEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_643,this.onSoundMachinePlayEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_796,this.onSoundMachineStopEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_603,this.onJukeboxInitEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_511,this.onDisposeEvent);
      }
      
      public function checkSongPlayState(param1:int) : void
      {
         if(this.var_269 == param1)
         {
            this.playSong(this.var_269);
         }
      }
      
      private function onJukeboxInitEvent(param1:Event) : void
      {
         this.startPlaying(this.const_1534);
      }
      ...
      {
         this.startPlaying(this.const_1797);
      }
      ...
      {
         if(this.var_1756 == this.const_1534)
         {
            this.var_74.shift();
         }
      ...
      {
         var _loc1_:IHabboSound = this.var_387[this.var_269] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_588 = this.var_588.splice(this.var_588.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_387[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_573.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_387.add(_loc3_.id,_loc7_);
            }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_703,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_85)
            {
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_643,this.onSoundMachinePlayEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_796,this.onSoundMachineStopEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_603,this.onJukeboxInitEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_511,this.onDisposeEvent);
               this.var_85 = null;
            }
            if(this.var_387)
            {
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_269 = param1;
         var _loc2_:IHabboSound = this.var_387.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_573.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_573.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_269)
         {
            _loc6_ = this.var_387[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_588.indexOf(param1) == -1)
         {
            this.var_588.push(param1);
         }
      }
      ...
      {
         var _loc2_:IHabboSound = this.var_387.getValue(this.var_269) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
