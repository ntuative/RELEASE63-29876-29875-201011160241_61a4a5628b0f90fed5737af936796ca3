package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1127:int = 14;
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_401,this.var_288,this._text,this.var_872);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_633,this.var_288);
      ...
      private function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1744 = param1.objectType;
         this._text = param1.text;
         this.var_872 = param1.colorHex;
      ...
      private function sendUpdate() : void
      {
         ...
         if(messageListener != null)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_401,this.var_288,this._text,this.var_872);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function showInterface() : void
      {
         ...
         if(this._window == null)
         {
            this._window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_58,HabboWindowStyle.const_35,0 | 0,new Rectangle(const_1135,const_1136,2,2),null,0) as IWindowContainer;
         ...
         if(_loc3_ != null)
         {
            ...
            _loc3_.addEventListener(WindowEvent.const_110,this.method_10);
         }
         _loc6_ = this._window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(this.var_1744 == "post_it_vd")
            {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_872);
            }
         ...
         this.setColorButtons(this._controller && this.var_1744 == "post_it");
      }
      ...
      private function method_10(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1128;
         if(_loc2_.numLines < const_1127)
         {
            return;
         }
