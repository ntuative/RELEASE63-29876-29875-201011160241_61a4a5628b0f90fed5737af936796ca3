package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_629,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_745,this.onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2010 = param1.presetId;
         this.var_982 = param1.effectId;
         this._color = param1.color;
         this.var_981 = param1.brightness;
         if(this._view != null)
         {
            this._view.update();
         }
         if(!this.validateBrightness(this.var_981,this.var_982))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_981,this.var_982 == 2);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         this.var_980 = param1.selectedPresetId - 1;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_981,this.var_982 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_629,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_745,this.onHide);
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc6_:DimmerFurniWidgetPresetItem = this._presets[this.var_980] as DimmerFurniWidgetPresetItem;
