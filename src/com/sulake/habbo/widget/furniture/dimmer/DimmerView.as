package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_584:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2431:int;
      
      private var var_380:DimmerViewAlphaSlider;
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1325 = XML(_loc1_.content);
         return this.var_1325;
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_58,HabboWindowStyle.const_35,0 | 0,new Rectangle(const_1135,const_1136,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_584 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_380 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_584 != null)
         {
            this.var_584.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_380 != null)
         {
            this.var_380.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1326 = _loc2_.light;
         if(this.var_380 != null)
         {
            this.var_380.setValue(this.var_1326);
         }
         this.var_479 = this.colors.indexOf(_loc2_.color);
         if(this.var_584 != null)
         {
            this.var_584.setSelectedColorIndex(this.var_479);
         }
