package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1539) as IWindowContainer;
            ...
            _loc3_.width = this.var_542.width;
            _loc3_.height = this.var_542.height;
            this.var_437.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_542.width,this.var_542.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_542,this.var_542.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_794.width,this.var_794.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_794,this.var_794.rect,new Point(0,0),null,null,true);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_437.numGridItems)
         {
            return;
         }
         this.select(this.var_437.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      {
         if(this._view == null || this.var_437 == null)
         {
            return;
         }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_300.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1539 = XML(_loc2_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_frame"));
         this.var_542 = BitmapData(_loc3_.content);
         ...
         this.var_794 = BitmapData(_loc3_.content);
      }
