package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_841:int = 16;
      
      private static const const_1188:int = 20;
      
      private static const const_537:int = 10;
      
      private static const const_1187:int = 40;
      ...
      {
         this.var_2309 = RoomWidgetChatMessage.const_104;
         super();
         this._widget = param1;
         ...
         this.var_2311 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2310 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_835 = new Timer(1000,1);
         this.var_835.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_1023 = new Timer(5000,1);
         this.var_1023.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_456.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_456 = _loc2_.text;
            if(!this.var_836)
            {
               this.var_836 = true;
               this.var_835.reset();
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_58,HabboWindowStyle.const_38,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_146,this.windowKeyEventProcessor);
         ...
         this._window.addEventListener(WindowEvent.const_321,this.onWindowMoved);
         this.var_1633 = true;
         this.var_456 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2312 = _loc2_.width + const_841 + _loc6_.width + const_1188;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1187,_loc8_.width) + const_841);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_433 = param1 - this.var_2312;
         var _loc2_:ITextFieldWindow = this._window.findChildByName("chat_input") as ITextFieldWindow;
         if(_loc2_ == null)
         {
            return;
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_836);
