package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private var var_678:Timer = null;
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         ...
         {
            this.var_677 = this.var_677 - 1;
            this._visualization.showFloodBlocking(this.var_677);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_772,this.onChatInputUpdate);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1008:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1385:
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_772,this.onChatInputUpdate);
      ...
      {
         this.var_2115 = param1.allowPaste;
      }
      ...
      {
         this.var_1276 = true;
         this.var_677 = param1.seconds;
         Logger.log("Enabling flood blocking for " + this.var_677 + " seconds");
         if(this.var_678)
         {
            this.var_678.reset();
         }
         ...
         {
            this.var_678 = new Timer(1000,this.var_677);
            this.var_678.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_678.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_678.start();
         if(this._visualization != null)
         {
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_729,this._visualization.window);
         if(messageListener != null)
         {
