package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_420:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_765:String = "POLL_OFFER_STATE_CANCEL";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     ...
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_659,this._id));
                     break;
                  case "poll_offer_button_cancel":
                     this._state = const_765;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_458,this._id));
