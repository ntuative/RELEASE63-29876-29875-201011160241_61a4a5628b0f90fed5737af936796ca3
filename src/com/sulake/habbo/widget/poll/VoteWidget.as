package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_948:Array = null;
      ...
      private var var_1338:int = 30000;
      
      private var var_1746:Boolean = false;
      
      private var var_1195:Array = null;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1338 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_340,this.update);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2077;
         if(_loc2_ > this.var_1338)
         {
            this.vote();
            return;
         }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_340,this.update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc4_ = Number(param1) / this.var_1338;
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1338 - param1) / 1000,0);
