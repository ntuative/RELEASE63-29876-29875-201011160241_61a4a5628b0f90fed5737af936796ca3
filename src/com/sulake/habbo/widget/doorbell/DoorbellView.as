package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         this._frame = (this.var_297.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._frame == null)
         {
      ...
      public function update() : void
      {
         ...
         if(this.var_51 != null)
         {
            ...
            {
               this.var_51.addListItem(this.createListItem(this.var_297.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
