package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_582:ChooserView;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_800,this.onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_118,this.onUpdateFurniChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_642,this.onUpdateFurniChooser);
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(this.var_582 == null)
         {
            this.var_582 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         this.var_582.populate(param1.items,param1.isAnyRoomController);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_800,this.onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_118,this.onUpdateFurniChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_642,this.onUpdateFurniChooser);
      }
   }
}
