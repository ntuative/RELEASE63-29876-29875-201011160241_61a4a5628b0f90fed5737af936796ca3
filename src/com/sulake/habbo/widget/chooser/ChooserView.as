package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1777:uint = 4.282169599E9;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_1632);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_834)
         {
            return;
         }
         if(this.var_834 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_834) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_834 % 2) ? uint(this.const_1518) : uint(this.const_1519);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_1777;
            this.var_834 = param1;
         }
      }
