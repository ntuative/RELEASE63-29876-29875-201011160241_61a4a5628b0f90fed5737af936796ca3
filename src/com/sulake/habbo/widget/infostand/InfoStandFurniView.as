package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_896 = this.var_195.findChildByTag("catalog");
         if(this.var_896 != null)
         {
            this.var_896.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_48.addListItem(this.var_896);
            }
            this.var_896.visible = param1;
         }
         else
         {
            this.var_48.removeListItem(this.var_896);
         }
      }
