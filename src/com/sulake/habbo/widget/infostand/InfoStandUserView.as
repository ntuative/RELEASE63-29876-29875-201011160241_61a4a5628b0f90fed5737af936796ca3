package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_945:TagListRenderer;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_945 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_195.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_195.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_195.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = this.var_195.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_116.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_116.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_116.x = _loc5_.left - this.var_116.width;
         this.var_116.y = _loc5_.top + (_loc5_.height - this.var_116.height) / 2;
      }
      ...
      public function set motto(param1:String) : void
      {
         ...
         var _loc3_:IWindowContainer = this.var_48.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_945.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_116 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_116 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_116.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = this.var_116.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_116.x = _loc7_.left - this.var_116.width;
         this.var_116.y = _loc7_.top + (_loc7_.height - this.var_116.height) / 2;
      }
