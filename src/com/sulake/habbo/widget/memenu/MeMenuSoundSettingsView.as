package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_444 = param1.volume;
         if(this.var_776 != null)
         {
            this.var_776.setValue(this.var_444);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1479 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1477 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1476 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1478 = (_loc5_.content as BitmapData).clone();
         }
         this.var_776 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(this.var_444 != 0)
               {
                  this.setBitmapWrapperContent("sounds_off_icon",this.var_1477);
               }
               break;
            case "sounds_on":
               if(this.var_444 != 1)
               {
                  this.setBitmapWrapperContent("sounds_on_icon",this.var_1478);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_444 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1479);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1477);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_444 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1476);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1478);
