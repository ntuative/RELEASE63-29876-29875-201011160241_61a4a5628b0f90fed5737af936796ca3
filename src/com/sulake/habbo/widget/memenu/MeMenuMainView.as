package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            this.var_128[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_128[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_128)
         {
            _loc6_ = this.var_128[_loc3_];
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_128["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_128["dance_icon"] = ["dance_white","dance_color"];
         this.var_128["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_128["effects_icon"] = ["effects_white","effects_color"];
         this.var_128["badges_icon"] = ["badges_white","badges_color"];
         this.var_128["wave_icon"] = ["wave_white","wave_color"];
         this.var_128["hc_icon"] = ["_white","_color"];
         this.var_128["settings_icon"] = ["settings_white","settings_color"];
         this.var_128["credits_icon"] = ["credits_white","credits_color"];
         this.var_128["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1067));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_641);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_925));
               this._widget.hide();
               break;
            case "clothes":
               ...
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_965));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_736);
               break;
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","HabboAvatarRenderLib_manifest") == "true";
               if(false && _loc4_)
               {
