   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_390,0,0,_loc4_,this.var_1594,this.var_1005,this.var_1003));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2272 = this._config.getKey("interstitial.enabled","HabboAvatarRenderLib_manifest") == "true";
         this.var_2275 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2273 = int(this._config.getKey("interstitial.show.time","5000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1250 = _loc2_.imageUrl;
         this.var_1594 = _loc2_.clickUrl;
         if(this.var_1250 != "" && this.var_1594 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1250);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1249 = _loc2_.imageUrl;
         this.var_2274 = _loc2_.clickUrl;
         this.var_1004 = getTimer();
         if(this.var_1249 != "")
         {
            _loc3_ = this.var_1249;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            ...
            {
               this.var_194 = new Timer(this.var_2273,1);
            ...
            this.var_194.start();
            _loc4_ = new URLRequest(this.var_1249);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_439,0,0,param1.bitmapData,this.var_2274));
            this.var_1004 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1592 > 0 && this.var_1593 >= this.var_1592)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1004;
         if(_loc1_ > this.var_2275)
         {
            ++this.var_1593;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_428));
         }
      }
