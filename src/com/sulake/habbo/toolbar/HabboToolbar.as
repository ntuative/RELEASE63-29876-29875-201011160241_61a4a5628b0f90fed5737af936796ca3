package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1233:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1233 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_901,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_180,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_96,this.onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_50,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_449,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_575,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_994,this.onHideWindowEvent);
         this._state = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_61));
      }
