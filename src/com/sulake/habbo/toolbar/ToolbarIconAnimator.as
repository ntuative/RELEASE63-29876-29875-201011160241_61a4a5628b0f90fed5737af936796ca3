package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1189 = param1.loop;
         if(param1.background != null)
         {
            this.var_770 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_771.push(new XML());
               this.var_772.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_772[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1189 == true || this.var_773 == 0)
         {
            if(this.var_771.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_771.length)
               {
                  this._frame = 0;
                  ++this.var_773;
               }
      ...
      {
         return this.var_771.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1189 == false && this.var_773 == 1 && this.var_1461 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_770.width),Math.max(param2.height,this.var_770.height));
            _loc3_.copyPixels(this.var_770,this.var_770.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_772.length)
         {
            _loc2_ = this.var_772[this._frame];
