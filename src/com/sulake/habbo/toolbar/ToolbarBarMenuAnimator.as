package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1140:Number = 90;
      
      private static const const_830:int = 50;
      
      private static const const_1143:Number = 25;
      
      private static const const_1173:int = 50;
      ...
      private var var_1239:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_548 = new Object();
         this.var_549 = new Array();
         this.var_547 = new Array();
         super();
         this._windowManager = param1;
         this.var_1239 = param2;
         this.var_647 = new Timer(const_1143);
         this.var_647.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_547.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_547.splice(_loc3_,1);
            this.var_549.splice(_loc3_,1);
         }
         this.var_549.push(param1.name);
         this.var_547.push(param2);
         param1.addEventListener(WindowEvent.const_321,this.windowEventListener);
      ...
      {
         return this.var_547[this.var_549.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1239.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_303.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         if(this.var_303.indexOf(param1) > -1)
         {
            if(const_189)
            {
            ...
            else
            {
               ...
               this.var_303.splice(this.var_303.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = this.var_1239.getIconLoc(param1.iconId);
      ...
      {
         return this.var_549[this.var_547.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_303[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_548[_loc3_] == null)
            {
               this.var_548[_loc3_] = new Array();
            }
            if(this.var_548[_loc3_].indexOf(param1) < 0)
            {
               this.var_548[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_830 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_830 || param1.desktop.height - param1.y < const_1173;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_549.length)
         {
            if(this.var_549[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_548[_loc3_].length)
                  {
                     this.repositionWindow(this.var_548[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_303.length)
         {
            _loc2_ = this._itemList[this.var_303[_loc7_]];
            if(_loc2_.active)
            {
