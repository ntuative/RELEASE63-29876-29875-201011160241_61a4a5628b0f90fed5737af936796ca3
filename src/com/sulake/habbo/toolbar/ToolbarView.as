package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_2615:Array;
      
      private var var_1102:Number = 1;
      
      private var var_1103:Boolean = true;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2615 = new Array();
         ...
         this.var_205 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_58,HabboWindowStyle.const_896,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1103 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1103)
         {
         ...
         this.var_1102 = _loc6_.toolbar.@margin_top;
         this.var_1344 = _loc6_.toolbar.@margin_bottom;
         this.var_1765 = _loc6_.toolbar.@min_group_margin;
         this.var_1764 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_271 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_238,param1,param2,this._window,this.var_271);
         this.createGroupsFromXmlList(_loc8_,this.var_590,param1,param2,this.var_205,this.var_271);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_145,this.var_478,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_205.x = this.var_145 + this.var_1764;
               this.var_205.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_205.x = 0;
               this.var_205.y = this.var_145 + this.var_1764;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1102;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_238.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1765,(this._window.height - _loc5_ * _loc8_ - this.var_1102 - this.var_1344) / (this.var_238.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1765,(this._window.width - _loc5_ * _loc8_ - this.var_1102 - this.var_1344) / (this.var_238.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      {
         if(this.var_1103 && this.var_1343)
         {
            this.var_1343 = false;
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_145,this.var_478);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_145,this.var_478);
         }
      }
