package com.sulake.habbo.room.utils
{
   ...
   public class LegacyWallGeometry implements IDisposable
   {
      ...
      private static const const_805:String = "l";
      ...
      public function getLocationOldFormat(param1:Number, param2:Number, param3:String) : IVector3d
      {
         ...
         while(_loc4_ < this._width)
         {
            ...
            {
               if(this.getTileHeight(_loc4_,_loc5_) <= this.var_745)
               {
                  _loc8_ = _loc4_ - 1;
                  _loc9_ = _loc5_;
               ...
               if(this.getTileHeight(_loc4_,_loc5_ + 1) <= this.var_745)
               {
                  _loc8_ = _loc4_;
                  _loc9_ = _loc5_;
         ...
         if(param1 == 0 && param2 == 0)
         {
            ...
            if(param5 == DIRECTION_RIGHT)
            {
               ...
               while(_loc7_ >= 0)
               {
                  ...
                  {
                     if(this.getTileHeight(_loc7_,_loc6_) <= this.var_745)
                     {
                        if(_loc6_ - 1 < param2)
                        {
                           param1 = _loc7_;
