package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_538:String = "room";
      
      private static const const_849:int = -2;
      
      private static const const_539:String = "temporary_room";
      
      private static const const_309:String = "object_icon_sprite";
      
      private static const const_848:int = -3;
      
      private static const const_847:String = "overlay";
      
      private static const const_1203:String = "selection_arrow";
      
      private static const const_1204:String = "tile_cursor";
      
      private static const const_385:int = 15;
      
      private static const const_308:int = -1;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_679 = new NumberBank(1000);
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1025);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_68 != null)
         {
            ...
            {
               return this.var_68.deleteWallItem(this.var_93,this.var_94,param1);
            }
         }
         return false;
      }
         ...
         while(_loc2_ < this.var_314.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_93 || _loc6_ != this.var_94 || !this.var_1036)
                  {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_68 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_68.modifyWallItemData(this.var_93,this.var_94,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_26 != null)
         {
            this.var_26.release(new IIDRoomObjectFactory());
            this.var_26 = null;
         }
         if(this.var_470 != null)
         {
            this.var_470.release(new IIDRoomObjectVisualizationFactory());
            this.var_470 = null;
         }
         if(this.var_41 != null)
         {
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1057;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_650);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_785);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_589);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_950);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1000) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1081);
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_583,this.var_93,this.var_94,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_68 != null)
         {
            return this.var_68.modifyRoomObject(this.var_93,this.var_94,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_723,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_593,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_788,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_41 != null)
         {
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_28);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_27);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_33);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_277);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_73);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_68 != null)
         {
            this.var_68.handleRoomObjectEvent(param1,this.var_93,this.var_94);
         }
      }
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1025,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.sessionDataManager = this.var_360;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_310,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_320,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1062,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_932,param10);
      ...
      {
         if(this.var_26 == null || this.var_470 == null || this.var_41 == null || this.var_846 == null || this._communication == null || this._habboConfiguration == null || !this.var_2350)
         {
            return;
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            events.addEventListener(RoomContentLoader.const_624,this.onContentLoaderReady);
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_308,RoomObjectCategoryEnum.const_73);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1355,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_848,RoomObjectCategoryEnum.const_277);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1279);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1279);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_470 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_15 != null)
         {
            this.var_15.visualizationFactory = this.var_470;
         }
         this.initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_26 != null)
         {
            if(this.var_26.events != null)
            {
               this.var_26.events.addEventListener(RoomObjectMouseEvent.const_197,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectMouseEvent.const_491,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectStateChangeEvent.const_163,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectStateChangeEvent.const_755,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_131,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_122,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_126,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_130,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_100,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_139,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_ACTIVATE,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_418,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_476,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_411,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_475,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_ONE_WAY_DOOR,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_496,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_393,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_403,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_494,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_444,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_62,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectMoveEvent.const_518,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectMoveEvent.const_504,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectRoomAdEvent.const_304,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectRoomAdEvent.const_526,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectRoomAdEvent.const_353,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectRoomAdEvent.const_374,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectRoomActionEvent.const_440,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectRoomActionEvent.const_1003,this.roomObjectEventHandler);
               this.var_26.events.addEventListener(RoomObjectRoomActionEvent.const_427,this.roomObjectEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_797) != 0)
         {
            return false;
         }
         if(this.var_68 != null)
         {
            return this.var_68.initializeRoomObjectInsert(this.var_93,this.var_94,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_460 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_699,0,0));
            _loc2_ = 0;
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_876,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_878,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_341);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_624)
         {
            this.var_2350 = true;
            this.initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_310,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_320,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1057,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_258,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_392);
                     break;
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_273.events.addEventListener(AdEvent.const_390,this.showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_847) as Sprite;
      }
      ...
      {
         var _loc8_:int = param2 - this.var_1278;
         var _loc9_:int = param3 - this.var_1280;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1036 = true;
               this.var_845 = false;
               this.var_2351 = this.var_1278;
               this.var_2352 = this.var_1280;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1036)
            {
               if(!this.var_845)
               {
                  _loc8_ = param2 - this.var_2351;
                  _loc9_ = param3 - this.var_2352;
                  if(_loc8_ <= -const_385 || _loc8_ >= const_385 || _loc9_ <= -const_385 || _loc9_ >= const_385)
                  {
                     this.var_845 = true;
                  }
                  _loc8_ = 0;
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_567) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_574) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_625) + 0.5;
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!this.var_460 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = this.var_41.getRoom(const_539);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_41.createRoom(const_539,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_679.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_392,param8);
               break;
            case RoomObjectCategoryEnum.const_33:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_170,param2);
               break;
            case RoomObjectCategoryEnum.const_73:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_159,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_147,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_147,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_265,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_766,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_767,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
         ...
         {
            this.var_1037.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_946,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            this.var_679.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_522,this.var_93,this.var_94,-1,RoomObjectCategoryEnum.const_155));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_68 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_308,const_538);
                     this.var_68.handleRoomObjectEvent(_loc14_,this.var_93,this.var_94);
                  }
               }
            }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_849,RoomObjectCategoryEnum.const_277);
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1279);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1278 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1280 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_356,param1.image,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_870,param1.adWarningL,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_875,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_964,RoomObjectVariableEnum.const_356,param1.clickUrl);
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_26 = param2 as IRoomObjectFactory;
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_68 != null)
         {
            this.var_68.cancelRoomObjectInsert(this.var_93,this.var_94);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_41.getRoom(const_539);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_946);
               ...
               this.var_679.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1037.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_93,this.var_94,const_308,RoomObjectCategoryEnum.const_73,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_308,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_883,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_797,1,true);
            _loc13_ = parseInt(this._habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1020,_loc13_,true);
            if(this.var_15 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_308,const_538,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_797,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_650,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_574,_loc17_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_960,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_723,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_593,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_788,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_391,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_213);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        ...
                        _loc7_.setNumber(RoomObjectVariableEnum.const_950,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_849,const_1204,RoomObjectCategoryEnum.const_277);
         _loc7_.createRoomObject(const_848,const_1203,RoomObjectCategoryEnum.const_277);
         return _loc7_;
      }
