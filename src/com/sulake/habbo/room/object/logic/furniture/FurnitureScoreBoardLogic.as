package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_811:int = 3000;
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_414 && param1 >= this.var_1197 + this.var_954)
            {
               _loc3_ = param1 - this.var_1197;
               _loc4_ = _loc3_ / this.var_954;
               _loc5_ = 1;
               if(this.var_414 < _loc2_)
               {
                  _loc5_ = -1;
               }
               if(_loc4_ > _loc5_ * (this.var_414 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_414 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1197 = param1 - (_loc3_ - _loc4_ * this.var_954);
            }
         }
      }
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_414 == 0)
         {
            object.setState(this.var_414,0);
            return;
         }
         var _loc2_:int = object.getState(0);
         if(this.var_414 != _loc2_)
         {
            _loc3_ = this.var_414 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_379 > const_811)
            {
               this.var_954 = const_811 / _loc3_;
            }
            else
            {
               this.var_954 = const_379;
            }
