   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_341,_loc4_.dirHead);
            return;
         }
         if(param1 is RoomObjectAvatarChatUpdateMessage)
         {
            ...
            this.var_1159 = getTimer() + _loc5_.numberOfWords * 1000;
            return;
         }
         if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
         {
            _loc6_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
            _loc2_.setString(RoomObjectVariableEnum.const_291,_loc6_.gesture);
         ...
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_510,Number(_loc8_.isSleeping));
            return;
         }
         if(param1 is RoomObjectAvatarSelectedMessage)
         {
            _loc9_ = param1 as RoomObjectAvatarSelectedMessage;
            this.var_173 = _loc9_.selected;
            this.var_402 = null;
            return;
         }
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1053,Number(getTimer()));
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc12_ = _loc2_.getString(RoomObjectVariableEnum.const_170);
            _loc2_.setString(RoomObjectVariableEnum.const_170,_loc11_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1281,_loc11_.race);
            return;
         }
      }
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_291,null);
            this.var_1158 = 0;
         }
         if(this.var_1159 > 0)
         {
