package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1447:int = 1500;
      
      private var var_1448:int = 255;
      
      private var var_1450:int = 255;
      
      private var var_1181:uint = 16777215;
      
      private var var_937:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_966,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_697,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_572,1);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1006,int(param1.bgOnly));
         this.var_1181 = this._color;
         this.var_1448 = this.var_1449;
         this.var_937 = _loc3_;
         this.var_1450 = _loc4_;
         this.var_938 = getTimer();
         this.var_1447 = 1500;
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_878:
               param2.setNumber(RoomObjectVariableEnum.const_572,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_876:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_391:
               ...
               this.var_430.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_562:
               _loc4_ = this.var_430.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_430.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_874,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_723:
               param2.setString(RoomObjectVariableEnum.const_720,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_593:
               param2.setString(RoomObjectVariableEnum.const_766,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_788:
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_938)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1449;
            if(_loc2_ - this.var_938 >= this.var_1447)
            {
               _loc3_ = this.var_937;
               _loc4_ = this.var_1450;
               this.var_938 = 0;
            }
            else
            {
               _loc7_ = this.var_1181 >> 16 & 255;
               _loc8_ = this.var_1181 >> 8 & 255;
               _loc9_ = this.var_1181 & 255;
               _loc10_ = this.var_937 >> 16 & 255;
               _loc11_ = this.var_937 >> 8 & 255;
               _loc12_ = this.var_937 & 255;
               _loc13_ = (_loc2_ - this.var_938) / this.var_1447;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1448 + (this.var_1450 - this.var_1448) * _loc13_;
               this._color = _loc3_;
               this.var_1449 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_697,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1367,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_159)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_147 || _loc13_ == RoomPlaneData.const_265)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
