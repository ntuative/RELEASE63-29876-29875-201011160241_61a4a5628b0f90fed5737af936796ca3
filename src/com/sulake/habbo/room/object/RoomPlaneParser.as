package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_745:Number = 0.0;
      ...
      private var var_967:Number = 0.0;
      
      private var var_422:int = 0;
      
      private var var_423:int = 0;
      
      private var var_113:Number = 0.0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_948;
         }
         var _loc2_:RoomPlaneData = this.var_112[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.type;
         }
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_147,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_265,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_967);
         this.addPlane(RoomPlaneData.const_147,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_147,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_113) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_147,Vector3d.sum(param1,Vector3d.product(param3,-this.var_113 / param3.length)),Vector3d.product(param3,(param3.length + this.var_113) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_967 / param2.length);
               this.addPlane(RoomPlaneData.const_147,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_112[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_745 = getFloorHeight(this.var_135);
         if(!param1)
         {
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_159,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_159,_loc13_,new Vector3d(0,0,-this.var_113),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_113,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,this.var_113,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_159,_loc13_,new Vector3d(0,0,-this.var_113),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_113,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,this.var_113,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_159,_loc13_,new Vector3d(0,0,-this.var_113),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_113,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,this.var_113,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_159,_loc13_,new Vector3d(0,0,-this.var_113),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_113,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,this.var_113,param11);
                  }
               }
            }
         }
