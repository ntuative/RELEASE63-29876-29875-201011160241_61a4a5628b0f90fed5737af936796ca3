package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneBitmapMaskParser
   {
      ...
      public function getMaskCategory(param1:int) : String
      {
         ...
         var _loc2_:RoomPlaneBitmapMaskData = this.var_168.getWithIndex(param1) as RoomPlaneBitmapMaskData;
         if(_loc2_ != null)
         {
      ...
      public function addMask(param1:String, param2:String, param3:IVector3d, param4:String) : void
      {
         ...
         this.var_168.remove(param1);
         this.var_168.add(param1,_loc5_);
      }
      ...
      public function reset() : void
      {
         ...
         {
            _loc2_ = this.var_168.getWithIndex(_loc1_) as RoomPlaneBitmapMaskData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         while(_loc6_ < _loc5_.length())
         {
            ...
            this.var_168.add(_loc8_,_loc14_);
            _loc6_++;
         }
         return true;
      }
      ...
      {
         var _loc2_:RoomPlaneBitmapMaskData = this.var_168.remove(param1) as RoomPlaneBitmapMaskData;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
