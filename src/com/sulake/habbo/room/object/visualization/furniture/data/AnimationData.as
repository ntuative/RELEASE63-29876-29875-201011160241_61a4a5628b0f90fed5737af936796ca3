package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_1617:int = 0;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_101 != null)
         {
            ...
            {
               _loc2_ = this.var_101.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_101.add(param1,_loc6_);
         var _loc11_:int = _loc6_.frameCount;
         if(_loc11_ > this.var_344)
         {
            this.var_344 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc5_:AnimationLayerData = this.var_101.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc3_:AnimationLayerData = this.var_101.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
      ...
      public function getStartFrame() : int
      {
         ...
         return Math.random() * this.var_344;
      }
