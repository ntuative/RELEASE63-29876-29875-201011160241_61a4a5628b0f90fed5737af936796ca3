package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_184[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_184.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_344 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:Boolean, param4:int) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc9_ = this.var_1427 * _loc8_;
            if(param3)
            {
               _loc9_ = 0;
            }
            _loc10_ = false;
            if(!this.var_1428 && !param2.isRandom)
            {
               if(param4 == this.var_184.length - 1 && param1 == param2.frameCount - 1)
               {
                  _loc10_ = true;
               }
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         var _loc2_:* = null;
         param1 /= this.var_1427;
         var _loc3_:Boolean = false;
         if(!this.var_1428)
         {
            _loc4_ = param1 / this.var_344;
            param1 %= this.var_344;
            if(this._loopCount > 0 && _loc4_ >= this._loopCount || this._loopCount <= 0 && this.var_344 == 1)
            {
               param1 = this.var_344 - 1;
               _loc3_ = true;
            }
            _loc5_ = 0;
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < this.var_184.length)
            {
               _loc2_ = this.var_184[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc7_ = this.var_184.length * Math.random();
         _loc2_ = this.var_184[_loc7_] as AnimationFrameSequenceData;
      ...
      public function getFrameFromSequence(param1:int, param2:int, param3:int) : AnimationFrame
      {
         ...
         var _loc4_:AnimationFrameSequenceData = this.var_184[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
