package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1496:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2578:int = -1;
      ...
      protected var var_1149:String = null;
      ...
      protected var var_2579:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc3_:String = this.var_882[param1];
         var _loc4_:Boolean = this.var_881[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            this.var_882[param1] = _loc3_;
            this.var_881[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1769 != spriteCount)
         {
            createSprites(this.var_1769);
         }
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_208 != _loc3_.getUpdateID())
         {
            this.var_2578 = _loc3_.getNumber(RoomObjectVariableEnum.const_231);
            ...
            this.var_1149 = _loc3_.getString(RoomObjectVariableEnum.const_320);
            if(this.var_1149 == null || this.var_1149.indexOf("http") != 0)
            {
               this.var_1149 = null;
            }
            var_208 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      {
         if(this.var_707[param1] != null && !this.var_1770)
         {
      ...
      {
         if(this.var_2481 != param1 || this.var_2482 != param2)
         {
            this.var_882 = [];
            this.var_881 = [];
            this.var_712 = [];
            ...
            this.var_1769 = this._data.getLayerCount(param2) + 1;
         }
      }
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param1 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,this.var_2578,param2);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_396 != _loc3_.getUpdateID() || param1 != var_246 || param2 != this.var_2579)
         {
