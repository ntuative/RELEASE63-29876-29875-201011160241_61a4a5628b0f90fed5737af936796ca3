   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < this.var_112.length)
         {
            ...
            _loc9_ = this.var_112[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1520;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_112 != null)
         {
            ...
            {
               _loc2_ = this.var_112[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_273);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_365);
