package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_333:int = 1000;
      ...
      private var var_1244:int = 360;
      
      private var var_1769:int = 0;
      
      private var var_998:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_654 = new DirectionData(param1);
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1244 / 2) % 360 / this.var_1244;
         if(this.var_222.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_222.getKey(_loc5_)) * this.var_1244;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_222.getKey(_loc4_));
         }
         return const_1297;
      }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_1071);
                  break;
               case "SUBTRACT":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_222.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_654;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_222 != null)
         {
            ...
            {
               _loc2_ = this.var_222.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_654,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(this.var_222.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_654);
            this.defineDirection(_loc3_,_loc8_);
            this.var_222.add(String(_loc7_),_loc3_);
            this.var_1584 = -1;
            this.var_998 = null;
            _loc5_++;
         }
