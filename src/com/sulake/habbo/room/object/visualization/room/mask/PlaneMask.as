package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            this.var_999 = this.var_449.getValue(String(this._sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            this.var_999 = null;
      ...
      {
         if(this.var_449.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc2_:PlaneMaskVisualization = new PlaneMaskVisualization();
         this.var_449.add(String(param1),_loc2_);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_449 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < this.var_449.length)
            {
               _loc1_ = this.var_449.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
