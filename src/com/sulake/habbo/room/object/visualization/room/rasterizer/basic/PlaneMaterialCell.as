package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_522:PlaneTexture;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         {
            _loc2_ = this.var_522.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  _loc3_ = Math.min(this.var_963,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_963,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_963,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_786[_loc6_ % this.var_786.length] as IGraphicAsset;
