   ...
   public class PlaneMaskManager
   {
      ...
      private function parseMasks(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc6_ < _loc5_.length())
         {
            ...
            {
               _loc8_ = _loc7_.@id;
               if(this.var_168.getValue(_loc8_) == null)
               {
                  ...
                  this.var_168.add(_loc8_,_loc9_);
               }
            }
            _loc6_++;
         }
      ...
      public function updateMask(param1:BitmapData, param2:String, param3:Number, param4:IVector3d, param5:int, param6:int) : Boolean
      {
         ...
         var _loc15_:* = NaN;
         var _loc16_:* = NaN;
         var _loc7_:PlaneMask = this.var_168.getValue(param2) as PlaneMask;
         if(_loc7_ != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_168 != null)
         {
            ...
            {
               _loc2_ = this.var_168.getWithIndex(_loc1_) as PlaneMask;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
