package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1552:int = 16777216;
      
      public static const const_1684:int = 1;
       
      
      private var var_2599:int = 69069;
      
      private var var_1533:int = 1;
      
      private var var_2600:int = 5;
      
      private var var_1534:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1534 * param2);
      }
      ...
      {
         var _loc1_:int = this.var_2599 * this.var_1533 + this.var_2600;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1534;
         this.var_1533 = _loc1_;
         return _loc1_;
      }
