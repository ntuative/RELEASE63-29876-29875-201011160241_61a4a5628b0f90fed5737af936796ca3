package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_959:Point = null;
      
      private var var_519:Array;
      
      private var var_1204:LayoutRasterizerData = null;
      ...
      public function LayoutRasterizer()
      {
         ...
         this.var_35 = new Map();
         this.var_779 = "";
         this.var_959 = new Point();
      }
      
      public function exchangeElementGraphics(param1:String, param2:String) : void
      {
         this.var_778 = true;
         var _loc3_:int = this.var_349.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_349.push(param1);
            this.var_518.push(param2);
            this.var_519.push(-1);
         }
         else
         {
            this.var_518[_loc3_] = param2;
         }
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         this.var_958 = param1;
         var _loc3_:LayoutRasterizerData = this.var_35.getValue(this.var_779);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1489 = RoomObjectVariableEnum.const_870;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1489 = RoomObjectVariableEnum.const_875;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_958 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_958 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_958 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_958 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1489);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2078);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_959.x = _loc3_.x;
         this.var_959.y = _loc3_.y;
      }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_779)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1204 = this.var_35.getValue(this.var_779);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_35.getValue(this.var_779);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1204.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_959.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_959.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_349.indexOf(_loc10_) >= 0 && this.var_778)
            {
               param1 = this.var_349.indexOf(_loc10_);
               if(this.var_518[param1] != "")
               {
                  _loc9_ = this.var_1203.getAsset(this.var_518[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               this.var_349.splice(param1,1);
               this.var_518.splice(param1,1);
