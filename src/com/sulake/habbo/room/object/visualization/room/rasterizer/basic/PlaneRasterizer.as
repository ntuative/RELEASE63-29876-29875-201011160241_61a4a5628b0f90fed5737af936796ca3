package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_529:String = "default";
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               while(_loc8_ < _loc7_.length())
               {
                  ...
                  this.var_304.add(_loc5_,_loc6_);
                  _loc8_++;
               }
            }
            _loc3_++;
      ...
      {
         return this.var_304.getValue(param1) as PlaneMaterial;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_112 != null)
         {
            ...
            {
               _loc2_ = this.var_112.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function resetMaterials() : void
      {
         ...
         {
            _loc2_ = this.var_304.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_112.getValue(param1);
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         {
            this.var_112.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      public function clearCache() : void
      {
         ...
         while(_loc1_ < this.var_304.length)
         {
            _loc3_ = this.var_304.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
