package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneTexture
   {
      ...
      public function getBitmap(param1:IVector3d) : BitmapData
      {
         ...
         {
            _loc3_ = this.var_598[_loc2_] as PlaneTextureBitmap;
            if(_loc3_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_598.length)
            {
               _loc2_ = this.var_598[_loc1_] as PlaneTextureBitmap;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
