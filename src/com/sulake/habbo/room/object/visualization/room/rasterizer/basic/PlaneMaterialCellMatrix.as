package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1282:int = const_318;
      ...
      public static const const_283:int = const_116;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_299.length == 1)
         {
            _loc4_ = this.var_299[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1549 == const_116)
         {
            _loc5_ = new Rectangle(0,0,this.var_28.width,this.var_543);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_28.height - this.var_543,this.var_28.width,this.var_543);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_28 != null)
            {
               if(this.var_28.width == param2 && this.var_28.height == param3 && Vector3d.isEqual(this.var_641,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_543,param6,param7);
                     return param1;
                  }
                  return this.var_28;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_299.length)
         {
            _loc11_ = this.var_299[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_641 != null)
         {
            this.var_641.assign(new Vector3d());
         }
         this.var_543 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_299.length)
         {
            _loc2_ = this.var_299[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_299.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_299[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_299[param1] = _loc5_;
