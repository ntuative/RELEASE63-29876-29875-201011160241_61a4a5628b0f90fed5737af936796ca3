   ...
   public class PetVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public function getAvatar(param1:String, param2:Number, param3:IPetImageListener) : IAvatarImage
      {
         ...
         if(this._avatarRenderer != null)
         {
            ...
            if(param2 > 48)
            {
               _loc4_ = this._avatarRenderer.createPetImageFromFigure(param1,AvatarScaleType.const_51,param3);
            }
            else
            {
               _loc4_ = this._avatarRenderer.createPetImageFromFigure(param1,AvatarScaleType.SMALL,param3);
            }
            return _loc4_;
         }
         return null;
