package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1509:int = 3;
      
      private var var_624:MarketplaceModel;
      
      private const const_1508:int = 42;
      
      private var var_424:Map;
      
      private var _disposed:Boolean = false;
      
      private const const_1803:int = 0;
      ...
      private const const_1507:int = 120;
      
      private var var_352:String;
      
      private const const_817:int = 1;
      
      private const const_1506:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_424.add(FurniModel.const_41,new FurniGridView(this.var_62,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_424.add(FurniModel.const_47,new FurniGridView(this.var_62,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         else if(param1.type == WindowEvent.const_59)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_313);
            }
         }
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_424.getValue(this.var_352);
         if(_loc3_)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_41,FurniModel.const_47];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_352);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_331)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_624 && this.var_624.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_352);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_817;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1506;
         }
         else
         {
            _loc2_ = this.const_1509;
         }
         if(this.var_2114 == _loc2_)
         {
            return;
         }
         this.var_2114 = _loc2_;
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1507)
         {
            _loc3_ = this.const_1507;
         }
         else if(_loc3_ < this.const_1508)
         {
            _loc3_ = this.const_1508;
         }
         else
         {
