package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_313:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_230,this.onObjectPlaced);
         this._catalog = param7;
         this.var_503 = new Timer(const_1111,1);
         this.var_503.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_1911 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_296;
      }
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_41,const_47];
         var _loc6_:int = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_230,this.onObjectPlaced);
               }
            ...
            {
               this.var_503.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_503.stop();
               this.var_503 = null;
            }
            if(this.var_172 != null)
            {
               this.var_172.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_172.stop();
               this.var_172 = null;
            }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_403.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_403.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_331)
         {
         ...
         if(this.var_749 == null)
         {
            this.var_749 = this._windowManager.buildFromXML(this.var_1911) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_749.clone() as IWindowContainer;
      ...
      public function removeAllLocks() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_41,const_47];
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.length)
         {
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_172 = new Timer(param1,1);
            this.var_172.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_172.start();
         }
         else
         {
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_41,const_47];
         var _loc8_:int = 0;
      ...
      {
         if(this.var_1165 && param1.type == RoomEngineObjectEvent.const_230)
         {
            this.var_1165 = false;
         }
      }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_403.add(const_41,new Array());
         this.var_403.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_351 || _loc3_.category == FurniCategory.const_331 || _loc3_.category == FurniCategory.const_363)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_403.getValue(param1);
      }
