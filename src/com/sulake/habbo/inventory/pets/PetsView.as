package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         this.var_436 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_300);
      }
      ...
      private function selectFirst() : void
      {
         ...
         this.setSelectedGridItem(this.var_544.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         ...
         {
            this.var_300.setSelected(false);
         }
         this.var_300 = param1;
         if(this.var_300 != null)
         {
            this.var_300.setSelected(true);
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_544.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_436.addGridItem(_loc2_.window);
            this.var_544.add(param1.id,_loc2_);
            if(this.var_300 == null)
            {
               this.selectFirst();
            }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_300.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = this.var_544.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_436.removeGridItem(_loc2_.window);
         if(this.var_300 == _loc2_)
         {
            this.var_300 = null;
            this.selectFirst();
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = this._avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_51,this);
            if(_loc13_ == null)
            {
               return;
            }
