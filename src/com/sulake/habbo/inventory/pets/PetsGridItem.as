package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      public function PetsGridItem(param1:PetsView, param2:PetData, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IAvatarRenderManager)
      {
         ...
         var _loc7_:IAvatarImage = param5.createPetImageFromFigure(param2.figure,AvatarScaleType.const_51);
         if(_loc7_ == null)
         {
            return;
         }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_40:
               this.var_1360.setSelectedGridItem(this);
               this.var_1361 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1361 = false;
                  this.var_1360.placePetToRoom(this.var_1330.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1768) : uint(this.const_1767);
      }
