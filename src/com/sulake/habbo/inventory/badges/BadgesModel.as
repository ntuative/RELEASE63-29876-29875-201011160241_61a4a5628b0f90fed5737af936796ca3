package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1775:int = 5;
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_803[_loc2_] == param1)
            {
               this.var_803.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_221[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_221.length)
               {
                  if((this.var_221[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_221[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_268 && this._controller.isVisible)
         {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_360.getBadgeImage(param1);
