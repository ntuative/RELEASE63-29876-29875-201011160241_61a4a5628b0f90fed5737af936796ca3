package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1057:IItemGridWindow;
      ...
      private var var_1058:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1058 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1058.procedure = this.inactiveGridEventProc;
         this.var_1057 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1057.procedure = this.activeGridEventProc;
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = this.var_1057.getGridItemIndex(param1.window);
      ...
      private function updateListViews() : void
      {
         ...
         this.var_1058.removeGridItems();
         this.var_1057.removeGridItems();
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               this.var_1058.addGridItem(_loc2_.window);
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            this.var_1057.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = this.var_1058.getGridItemIndex(param1.window);
