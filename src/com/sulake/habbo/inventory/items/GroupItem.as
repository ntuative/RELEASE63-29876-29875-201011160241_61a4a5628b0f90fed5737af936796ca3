package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1767:int = 13421772;
      ...
      protected var var_2562:BitmapData;
      
      protected var var_1384:Boolean;
      
      protected var var_875:Boolean;
      
      protected var var_2465:int;
      
      protected var _mainCategory:String;
      
      protected var var_732:int = 0;
      
      protected var var_1842:String;
      
      private const const_1768:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_599:BitmapData;
      
      private const const_1500:Number = 0.2;
      
      protected var var_1843:Boolean;
      
      private const const_1501:Number = 1;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_1843 = param7;
         this._items = new Map();
         this._mainCategory = param2;
         this._category = param3;
         this.var_1842 = param8;
         this.var_1424 = param9;
         if(param10 != null)
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_620)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1424));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1842);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_732 = _loc1_.id;
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1500;
               _loc1_.blend = this.const_1500;
            }
            else
            {
               this._window.blend = this.const_1501;
               _loc1_.blend = this.const_1501;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1843 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2562;
               _loc5_.visible = true;
            }
            else
            {
