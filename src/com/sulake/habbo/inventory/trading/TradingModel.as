package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_285:uint = 3;
      
      public static const const_174:uint = 1;
      
      public static const const_157:uint = 0;
      
      public static const const_1465:uint = 9;
      ...
      public function TradingModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager)
      {
         ...
         this.var_47 = new TradingView(this,param2,param4,param5,param6);
      }
      ...
      {
         this.var_47.updateItemImage(param1,param2);
      }
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         this.var_670 = false;
         this.var_1026 = false;
         this.var_47.updateItemList(this.var_671);
         this.var_47.updateItemList(this.var_1267);
         this.var_47.updateUserInterface();
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_47.alertPopup(TradingView.const_947);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_671)
            {
               this.var_670 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1026 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_47.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_671)
            {
               this.var_47.alertPopup(TradingView.const_1039);
            }
            this.close();
         }
         ...
         {
            this.var_47.showOtherUserNotification("${inventory.trading.warning.others_account_disabled}");
         }
         else if(param1 is TradingYouAreNotAllowedEvent)
         {
            this.var_47.showOwnUserNotification("${inventory.trading.warning.own_account_disabled}");
         }
         else
         {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_670 + " OTHER: " + this.var_1026);
         ...
         {
            case const_157:
               if(param1 == const_174 || param1 == const_244)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
            ...
            case const_174:
               ...
               {
                  this._state = param1;
                  this.var_47.setMinimized(false);
                  _loc2_ = true;
               }
               break;
            case const_346:
      ...
      {
         return this.var_47.getWindowContainer();
      }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_261.length)
         {
            _loc2_ = this.var_261.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         this.var_47.setMinimized(param1 != InventoryCategory.const_78);
         this._inventory.updateSubView();
      }
      
      public function startConfirmCountdown() : void
      {
         this.var_47.startConfirmCountdown();
      }
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_47.setup(param1,param3,param4,param6);
         this.var_47.updateItemList(this.var_671);
         this.var_47.updateItemList(this.var_1267);
         this.var_47.updateUserInterface();
         this.var_47.clearItemLists();
         this._inventory.toggleInventoryPage(InventoryCategory.const_78);
      ...
      {
         this.var_47.cancelConfirmCountdown();
      }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_261.length < const_1465)
         {
      ...
      public function close() : void
      {
         if(this.var_640)
         {
            if(this._state != const_157 && this._state != const_244)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_157;
