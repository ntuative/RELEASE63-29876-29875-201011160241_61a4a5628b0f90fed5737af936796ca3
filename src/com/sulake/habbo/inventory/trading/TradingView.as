package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_810:uint = 4284532064;
      
      private static const const_809:uint = 2577770;
      
      public static const const_1089:int = 0;
      ...
      private var var_347:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_347 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      private function method_3(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc5_:* = null;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_347.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_437);
            this.var_347.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_347.hideDelayed();
         }
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_175)
            {
               this.var_175.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_175.stop();
               this.var_175 = null;
            }
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_175.currentCount));
         if(this.var_175.currentCount == 3)
         {
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1460 = this.createMinimizedWindow();
         }
         if(!this.var_2017)
         {
            return this.var_64;
      ...
      private function createNormalWindow() : IWindowContainer
      {
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.id = _loc6_;
            _loc4_.procedure = this.method_3;
            _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.method_3);
            _loc4_.addEventListener(WindowMouseEvent.const_25,this.method_3);
            _loc6_++;
         }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_175 = new Timer(1000,3);
            this.var_175.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_175.reset();
         this.var_175.repeatCount = 3;
         this.var_175.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_810) : uint(const_809);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_810) : uint(const_809);
            }
