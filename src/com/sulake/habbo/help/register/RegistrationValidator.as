package com.sulake.habbo.help.register
{
   ...
   public class RegistrationValidator
   {
      ...
      public static const const_1261:RegExp = /^[A-Z0-9._%+-]+@(?:[A-Z0-9-]+\.)+[A-Z]{2,4}$/i;
      
      public static const const_1228:RegExp = /[0-9]/;
      
      public static const const_1469:RegExp = /[a-zA-Z]/;
      ...
      {
         if(param1 == null || !param1.match(const_1261))
         {
