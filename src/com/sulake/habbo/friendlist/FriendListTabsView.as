package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_348);
         }
      }
      ...
      public function refresh(param1:String) : void
      {
         ...
         this.var_158.width = this._friendList.tabs.tabContentWidth;
         this.var_158.findChildByName("bg").width = this._friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in this._friendList.tabs.getTabs())
         {
            _loc4_ = this.var_158.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         this.var_158.height = _loc2_ + 1;
         this.var_158.findChildByName("bg").height = this.var_158.height;
