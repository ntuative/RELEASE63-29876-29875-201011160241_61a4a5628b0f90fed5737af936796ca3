package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_1289:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1289 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_828 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_239 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1289.prepare(this.var_828);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_968,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_931,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_555,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_561,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_555,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_561,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1290 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1290.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_239.y = Util.getLowestPoint(this.var_16.content);
         this.var_239.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1049,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_555,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_968,false);
         ...
         this.var_1673 = this.var_16.height;
         this.var_1674 = this.var_16.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1673 == -1 ? 0 : int(this.var_16.height - this.var_1673);
         var _loc4_:int = this.var_1674 == -1 ? 0 : int(this.var_16.width - this.var_1674);
