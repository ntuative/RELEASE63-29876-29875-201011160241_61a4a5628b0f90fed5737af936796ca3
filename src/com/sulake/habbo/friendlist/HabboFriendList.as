package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1629:OpenedToWebPopup;
      
      private var var_1022:IAvatarRenderManager;
      
      private var var_132:IHabboToolbar;
      
      private var var_340:FriendListTabs;
      
      private var _localization:IHabboLocalizationManager;
      
      private var _view:FriendListView;
      
      private var var_117:IHabboMessenger;
      
      private var var_1628:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_668:ISessionDataManager;
      
      private var var_310:FriendRequests;
      
      private var var_1943:int;
      
      var var_88:FriendCategories;
      
      private var var_2299:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_806:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2299 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_88 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1628 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_310.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_310.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_340.findTab(FriendListTab.const_92).setNewMessageArrived(true);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_88.getFriendNames();
      }
      ...
      {
         this.var_668 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_310 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_88.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_88.addCategory(new FriendCategory(FriendCategory.const_969,this.getText("friendlist.friends")));
         this.var_88.addCategory(new FriendCategory(FriendCategory.const_451,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_88.addFriend(new Friend(_loc4_));
         }
         this.var_340 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_562)
         {
         ...
         this.var_132.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_117)
         {
            this.var_117.release(new IIDHabboMessenger());
            this.var_117 = null;
         }
         if(this.var_157)
         {
         ...
         if(this.var_806)
         {
            this.var_806.release(new IIDHabboNotifications());
            this.var_806 = null;
         }
         if(this.var_132)
         {
         ...
         if(this.var_668)
         {
            this.var_668.release(new IIDSessionDataManager());
            this.var_668 = null;
         }
         super.dispose();
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_286,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_117 = param2 as IHabboMessenger;
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.var_88.getAllFriends();
      ...
      {
         this.var_88.onFriendListUpdate(param1);
      ...
      {
         var _loc1_:String = this.var_157.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_340.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1628.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_310.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_132.events.dispatchEvent(_loc1_);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_88.findFriend(param1);
      }
      ...
      {
         if(!this.var_668 || !this.var_310)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_668.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_310.vipLimit;
         }
         else if(this.var_668.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_310.clubLimit;
         }
         if(_loc2_ > this.var_310.limit)
         {
            this.var_310.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_340.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = this.var_1022.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_310.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_340.findTab(FriendListTab.const_92);
      ...
      {
         this.var_806 = param2 as IHabboNotifications;
      ...
      {
         return this.var_157.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1629 = new OpenedToWebPopup(this);
         }
         this.var_1629.show(x,y);
      }
