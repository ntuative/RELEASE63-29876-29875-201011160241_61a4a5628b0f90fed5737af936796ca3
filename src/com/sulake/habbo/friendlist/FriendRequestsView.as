package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1513:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_358 && _loc4_.state != FriendRequest.const_347)
            {
      ...
      {
         this.var_1573 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1572 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1572.procedure = this.onDismissAllButtonClick;
         this.var_1573.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1573,_loc1_);
         this.setEnabled(this.var_1572,_loc1_);
      }
