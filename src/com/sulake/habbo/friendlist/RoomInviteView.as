package com.sulake.habbo.friendlist
{
   ...
   public class RoomInviteView extends AlertView
   {
      ...
      public function RoomInviteView(param1:HabboFriendList)
      {
         ...
         this.var_173 = param1.categories.getSelectedFriends();
      }
      ...
      private function sendMsg() : void
      {
         ...
         for each(_loc3_ in this.var_173)
         {
      ...
      {
         friendList.registerParameter("friendlist.invite.summary","count","" + this.var_173.length);
         this.var_750 = ITextFieldWindow(param1.findChildByName("message_input"));
