package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_1993:IContainerButtonWindow;
      
      private var var_1995:IContainerButtonWindow;
      
      private var var_347:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_347 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_1994 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_1993 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_1996 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_1995 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_347.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_347.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_347.closePopup();
         }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1994,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_1993,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_1996,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_1995,this.isEnableRemoveButton(_loc1_));
      }
