package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1309:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_589 = this.getKey("url_prefix");
         if(this.var_589 != null && this.var_589.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_589 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_589 = this.getKey("url.prefix");
         if(this.var_589.length > 0)
         {
            externalAccessDomain = this.var_589.replace("http://","");
      ...
      {
         var _loc4_:String = this.var_1100[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_589);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1309);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1309,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      private function init() : void
      {
         ...
         if(!this.var_851)
         {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.const_45,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1476);
      }
      ...
      {
         var _loc2_:String = this.var_1100[param1] as String;
         return _loc2_ != null;
      }
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         if(param3)
         {
            if(this.var_1100[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1760.indexOf(param1) < 0)
         {
