package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_639:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_639.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_639.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_639.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_639.remove(param1);
         var_639.add(param1,param2);
      }
