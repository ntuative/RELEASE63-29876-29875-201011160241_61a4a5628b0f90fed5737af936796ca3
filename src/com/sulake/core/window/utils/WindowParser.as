package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1700:String = "_INCLUDE";
      
      public static const const_1007:String = "_EXCLUDE";
      
      public static const const_1759:String = "_TEMP";
      
      private static const const_1109:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1110:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1133:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_909:Dictionary;
      
      protected var var_1844:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1133);
         this.var_909 = new Dictionary();
         this.var_1385 = new Dictionary();
         ParamCodeTable.fillTables(this.var_909,this.var_1385);
         this.var_1844 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1110,"");
         return param1.replace(const_1109,"");
      }
      
      private function method_8(param1:XML) : Array
      {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_909)
            {
               delete this.var_909[_loc1_];
            }
            for(_loc1_ in this.var_1385)
            {
               delete this.var_1385[_loc1_];
            }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         window = this.var_17.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.method_8(xml.child("variables")[0]),tags) as WindowController;
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1133[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1007) == -1)
                  {
