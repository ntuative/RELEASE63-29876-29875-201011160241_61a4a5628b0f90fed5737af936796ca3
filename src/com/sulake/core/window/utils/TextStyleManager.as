package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_209:IEventDispatcher = new EventDispatcher();
      
      public static const BOLD:String = "bold";
      
      private static var var_302:Map = new Map();
      
      public static const ITALIC:String = "italic";
      
      public static const const_1378:String = "regular";
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_302.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      {
         return var_302.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_302.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_302[param1] = param2;
         if(_loc3_)
         {
            var_209.dispatchEvent(new Event(Event.ADDED));
         }
         else
         {
            var_209.dispatchEvent(new Event(Event.CHANGE));
         }
      }
      ...
      {
         return var_302[param1].getStyle(param1);
      }
   }
}
