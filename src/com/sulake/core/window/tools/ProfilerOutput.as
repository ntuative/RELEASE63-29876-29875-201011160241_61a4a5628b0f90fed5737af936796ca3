package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1186:Class = ProfilerOutput_profiler_task_xml;
      
      private static var var_1187:Class = ProfilerOutput_profiler_dialog_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_22:CoreComponent;
      
      private var _window:IFrameWindow;
      
      private var var_133:IProfiler;
      ...
      private var var_2589:Array;
      
      public function ProfilerOutput(param1:CoreComponent, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         super();
         this.var_22 = param1;
         this.var_2589 = new Array();
         this.var_133 = this.profiler;
         this._windowManager = param2;
         this.var_759 = param3;
         var _loc4_:ByteArray = new var_1187() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_133)
         {
            this.var_133.removeStopEventListener(this.refresh);
            this.var_133 = null;
         }
         if(!this.var_133 && param1)
         {
            this.var_133 = param1;
            this.var_133.addStopEventListener(this.refresh);
         }
      }
      ...
      {
         var _loc2_:Array = this.var_133.getProfilerAgentsInArray();
         ...
         if(this.var_1459)
         {
            ITextWindow(this._window.findChildByName("footer")).text = "Assets - Libraries: " + this.var_133.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_133.numBitmapAssetInstances + " / " + this.var_133.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_759.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_133.numTrackedBitmapDataInstances + " / " + this.var_133.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1186() as ByteArray;
