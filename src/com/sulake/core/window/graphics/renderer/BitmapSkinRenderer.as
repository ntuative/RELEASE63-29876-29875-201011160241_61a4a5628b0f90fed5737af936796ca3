package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_739:Dictionary;
      
      private var var_880:Matrix;
      
      protected var var_740:Dictionary;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_740 = new Dictionary(false);
         this.var_739 = new Dictionary(false);
         this.var_880 = new Matrix();
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_395[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  _loc13_.x += param3.x;
                  _loc13_.y += param3.y;
                  if(_loc11_.scaleH == SkinLayoutEntity.const_260)
                  {
                     _loc13_.x += _loc16_;
                  }
                  ...
                  if(_loc11_.scaleV == SkinLayoutEntity.const_260)
                  {
                     _loc13_.y += _loc17_;
                  }
                  ...
                  {
                     this.var_880.a = _loc13_.width / _loc19_.width;
                     this.var_880.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,this.var_880);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,this.var_880,null);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_880 = null;
            for(_loc1_ in this.var_740)
            {
               _loc2_ = this.var_740[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_740[_loc1_];
            }
            this.var_740 = null;
            for(_loc1_ in this.var_739)
            {
               _loc2_ = this.var_739[_loc1_] as BitmapData;
               _loc2_.dispose();
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_739[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_740[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_260)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_260)
               {
