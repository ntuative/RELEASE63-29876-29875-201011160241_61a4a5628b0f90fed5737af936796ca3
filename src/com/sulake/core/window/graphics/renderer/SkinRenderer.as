package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_395:Dictionary;
      
      protected var var_336:Dictionary;
      
      protected var _templatesByState:Dictionary;
      
      private var _name:String;
      
      protected var var_494:Dictionary;
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_336[param1.name];
         if(param1 != null)
         {
            ...
            delete this.var_336[param1.name];
         }
         return param1;
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_494)
            {
               ISkinLayout(this.var_494[_loc1_]).dispose();
               delete this.var_494[_loc1_];
            }
            this.var_494 = null;
            this.var_395 = null;
            for(_loc1_ in this.var_336)
            {
               ISkinTemplate(this.var_336[_loc1_]).dispose();
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in this.var_395)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_395[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_494[param1.name];
         }
         return param1;
      }
