package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_866:uint = 1;
      
      private static const const_865:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1346 = 4294967295;
         this.var_883 = 0;
         this.var_1771 = new ColorTransform();
         this.var_916 = new Matrix();
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_527:
            ...
            case WindowRedrawFlag.const_933:
               this.var_883 = this.var_758.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_883 != this.var_1346)
               {
                  this.var_591 = true;
                  _loc4_ = true;
               }
      ...
      {
         return this.var_758.getTheActualState(param1.type,param1.style,param1.state) != this.var_1346;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_865) : uint(const_544);
         var _loc6_:Boolean = this.var_165.width > 0 && this.var_165.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_883))
            {
               _loc5_ = const_866;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_866)
               {
                  ...
                  if(this.var_591)
                  {
                     ...
                     _loc7_.draw(param1,this.var_95,this.var_95.rect,this.var_883,false);
                  ...
                  {
                     this.var_916.tx = param2.x;
                     this.var_916.ty = param2.y;
                     this.var_1771.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_95,this.var_916,this.var_1771,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_758.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_278)
            {
               _loc2_ = this.var_758.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_278);
            }
         }
         return _loc2_;
      }
