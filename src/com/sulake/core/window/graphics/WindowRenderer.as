package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1272:Rectangle;
      ...
      private var var_262:Rectangle;
      
      private var var_1641:Point;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1641 = new Point();
         this.var_1272 = new Rectangle();
         this.var_262 = new Rectangle();
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_673.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_673.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_262.x = _loc3_.dirty.x;
               this.var_262.y = _loc3_.dirty.y;
               this.var_262.width = _loc3_.dirty.width;
               this.var_262.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_262,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_679,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_312[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1641,this.var_1272))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1641,this.var_1272))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_31))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1272);
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_758);
            this.var_312[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_679,this.windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_262.x = param2.x - param1.x;
            this.var_262.y = param2.y - param1.y;
            this.var_262.width = param2.width;
            this.var_262.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_31))
            {
               while(param1.testParamFlag(WindowParam.const_31))
               {
                  ...
                  this.var_262.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_262,WindowRedrawFlag.const_906);
