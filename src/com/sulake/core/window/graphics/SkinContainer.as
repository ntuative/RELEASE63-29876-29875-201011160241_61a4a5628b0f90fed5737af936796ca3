package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1198:String = "unknown";
      
      private static const const_1199:String = "skin";
      
      private static const const_1196:String = "null";
      
      private static const const_842:uint = 8;
      
      private static const const_1200:String = "text";
      
      private static const const_1197:String = "shape";
      
      protected static var var_279:Array;
      
      private static const const_1201:String = "fill";
      
      private static const const_1202:String = "bitmap";
      ...
      private var var_2328:Dictionary;
      
      private var var_1642:Dictionary;
      
      private var var_842:Dictionary;
      
      private var var_2329:Dictionary;
      
      private var var_459:Dictionary;
      
      private var var_2330:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1642 = new Dictionary();
         this.var_2329 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1642,this.var_2329);
         this.var_2330 = new Dictionary();
         this.var_2328 = new Dictionary();
         StateCodeTable.fillTables(this.var_2330,this.var_2328);
         this.var_459 = new Dictionary();
         this.var_459[const_1199] = BitmapSkinRenderer;
         this.var_459[const_1202] = BitmapDataRenderer;
         this.var_459[const_1201] = FillSkinRenderer;
         this.var_459[const_1200] = TextSkinRenderer;
         this.var_459[const_1197] = ShapeSkinRenderer;
         this.var_459[const_1198] = SkinRenderer;
         this.var_459[const_1196] = NullSkinRenderer;
         if(var_279 == null)
         {
            var_279 = new Array();
            var_279.push(WindowState.const_67);
            var_279.push(WindowState.const_70);
            var_279.push(WindowState.const_83);
            var_279.push(WindowState.const_49);
            var_279.push(WindowState.WINDOW_STATE_HOVERING);
            var_279.push(WindowState.const_80);
            var_279.push(WindowState.const_99);
            var_279.push(WindowState.const_90);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1642[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_842[param1] = new Array(const_842);
         }
         this.var_842[param1][param2] = param3;
         if(this.var_841[param1] == null)
         {
            this.var_841[param1] = new Array(const_842);
         }
         this.var_841[param1][param2] = param4;
      }
      ...
      public function getDefaultAttributesByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_278)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_842[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_278)
