package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1157:String = "_CONTENT";
      
      private static const const_1156:String = "_SELECTOR";
       
      
      private var var_1624:Boolean = false;
      
      protected var var_912:ITabSelectorWindow;
      
      private var var_851:Boolean = false;
      
      protected var var_1850:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1850 = findChildByTag(const_1157) as IWindowContainer;
         }
      ...
      {
         return this.var_912.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_912 = findChildByTag(const_1156) as ITabSelectorWindow;
            if(this.var_912 != null)
            {
               this.var_912.procedure = this.selectorEventProc;
            }
         }
         return this.var_912;
      }
      ...
      {
         return !!this.var_851 ? this.selector.iterator : null;
      }
