package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1118:String = "increment";
      
      private static const const_530:String = "slider_bar";
      
      private static const const_1119:String = "decrement";
      ...
      protected var var_601:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_147 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_402;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_530:
         ...
         if(param2.type == WindowNotifyEvent.const_495)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_269)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_601;
                  }
                  else
                  {
                     this.scrollV -= this.var_601;
                  }
               }
      ...
      {
         return findChildByName(const_808) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_528,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_528,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return this.track.findChildByName(const_530) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_756 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_756) as IScrollableWindow;
            if(_loc1_ == null && var_13 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_13).findChildByName(this.var_756) as IScrollableWindow;
               if(_loc1_)
               {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_40 || param1.type == WindowTouchEvent.const_407)
         {
            ...
            else if(param2.name == const_1119)
            {
               if(this.var_18)
               {
                  this.var_930 = true;
            ...
            else if(param2.name == const_808)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_530).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
