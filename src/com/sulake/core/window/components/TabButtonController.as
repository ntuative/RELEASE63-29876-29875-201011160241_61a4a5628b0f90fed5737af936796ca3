package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1531:String = "TAB_BUTTON_ICON";
      
      private static const const_1530:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1211:String = "TAB_BUTTON_TITLE";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1211));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
