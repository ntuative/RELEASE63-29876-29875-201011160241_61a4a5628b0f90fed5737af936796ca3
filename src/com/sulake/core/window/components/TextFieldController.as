package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_851:Boolean = false;
      ...
      {
         this.var_1152 = param1 == null ? "" : param1;
      }
      ...
      private function onRemovedEvent(param1:Event) : void
      {
         ...
         {
            var_17.handleError(WindowContext.const_319,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",this.var_1132,PropertyStruct.const_48,this.var_1132 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_851 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      {
         if(param1.type == WindowTouchEvent.const_407)
         {
            this.focus();
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_1132 = _loc2_.value as Boolean;
               if(this.var_1132)
               {
