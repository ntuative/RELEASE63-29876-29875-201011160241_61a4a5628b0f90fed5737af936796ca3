package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_357)
         {
            this.var_357 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_357)
            {
               this.var_357.addEventListener(WindowEvent.const_261,this.scrollBarEventProc);
               this.var_357.addEventListener(WindowEvent.const_233,this.scrollBarEventProc);
            }
         }
         return this.var_357;
      }
      ...
      override public function dispose() : void
      {
         if(this.var_357)
         {
            this.var_357.removeEventListener(WindowEvent.const_261,this.scrollBarEventProc);
            this.var_357.removeEventListener(WindowEvent.const_233,this.scrollBarEventProc);
            this.var_357 = null;
         }
         if(this.var_977)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_977)
         {
            this.var_977 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return this.var_977;
      }
