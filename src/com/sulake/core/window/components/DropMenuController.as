package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_377:String = "_DROPMENU_TITLETEXT";
      
      protected static const const_1097:String = "item_array";
      
      protected static const const_1096:String = "_DROPMENU_ITEMLIST";
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            this.var_153 = context.create(name + "::submenu","",WindowType.const_487,var_76,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1097,this._itemArray,PropertyStruct.const_150,this._itemArray.length > 0));
         return _loc1_;
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1096) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_469,var_76,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_362,var_76,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_523 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_523).setStateFlag(WindowState.const_49,true);
         }
      }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_426,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_523 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_315,this,null));
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_40 || param1.type == WindowTouchEvent.const_407)
         {
            if(param2 is IDropMenuItemWindow)
            {
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1096) as IItemListWindow;
         if(_loc3_ != null)
         {
      ...
      {
         return getChildByName(DropMenuController.const_377) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_788 = false;
            this.getTitleText().text = this.var_523 < this._itemArray.length && this.var_523 > -1 ? this._itemArray[this.var_523] : caption;
         }
      }
   }
}
