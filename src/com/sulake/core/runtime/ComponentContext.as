   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               this.error("Interface " + param1 + " still unavailabe!",true,Core.const_1275);
            }
      ...
      public final function loadFromFile(param1:URLRequest, param2:LoaderContext) : LibraryLoader
      {
         ...
         {
            if(this.var_247[_loc3_].url == param1.url)
            {
               return this.var_247[_loc3_].loadFromFile(param1);
            }
            _loc3_++;
         }
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc11_:int = 0;
         while(_loc11_ < this.var_278.length)
         {
            _loc10_ = this.var_278[_loc11_] as Component;
            if(_loc10_ != this)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc1_ = uint(this.var_278.length);
               while(_loc1_-- > 0)
               {
                  IUnknown(this.var_278.pop()).dispose();
               }
               this.var_278 = null;
            }
            if(this.var_397 != null)
            {
               _loc1_ = uint(this.var_397.length);
               while(_loc1_-- > 0)
               {
                  IDisposable(this.var_397.pop()).dispose();
               }
               this.var_397 = null;
            }
            if(this.var_247 != null)
            {
               _loc1_ = uint(this.var_247.length);
               while(_loc1_-- > 0)
               {
                  _loc2_ = this.var_247[0];
      ...
      protected final function getQueueForInterface(param1:IID) : ComponentInterfaceQueue
      {
         ...
         var _loc4_:uint = this.var_397.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc3_ = this.var_397[_loc5_];
      ...
      {
         var _loc2_:String = getQualifiedClassName(param1);
         var _loc3_:uint = this.var_397.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            if(getQualifiedClassName(this.var_397[_loc4_].identifier) == _loc2_)
            {
               return true;
            }
            _loc4_++;
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.removeLibraryLoader(_loc2_);
         this.error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1250);
      }
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     this.error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_631);
                  }
                  k++;
               }
            }
            ...
            if(componentClass == null)
            {
               this.error("Invalid component class " + componentString + "!",true,Core.const_631);
               return null;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     this.error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_631);
                  }
               }
      ...
      public final function attachComponent(param1:Component, param2:Array) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_278.indexOf(param1) > -1)
         {
