package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_830:Array = new Array();
      
      private static var var_260:Dictionary;
      
      private static var var_455:uint = 0;
      
      public static const const_882:String = "AssetLibraryReady";
      
      public static const const_1462:String = "AssetLibraryUnloaded";
      ...
      public static const const_1437:String = "AssetLibraryLoadError";
       
      
      private var var_669:XML;
      ...
      private var var_833:Boolean = true;
      
      private var var_563:Class;
      
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_669 = new XML();
         this.var_370 = 0;
         ...
         ++var_455;
         this.var_371 = new Dictionary(false);
         this.var_454 = new Dictionary(false);
         this.var_832 = new Dictionary(false);
         this.var_139 = new Dictionary(false);
         var_830.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_371)
         {
            _loc4_ = AssetTypeDeclaration(this.var_371[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_832)
         {
            delete this.var_832[_loc1_];
         }
         if(this.var_38 != null)
         {
            this.var_38.dispose();
         ...
         this.var_831 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1462));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_669 = _loc2_.manifest.copy();
         this.var_563 = _loc2_.resource;
         this._file = _loc2_.url;
         if(this.var_833)
         {
            AssetLibrary.fetchLibraryContents(this,this.var_669,this.var_563);
         }
         this.var_831 = true;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_454[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_936,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1082,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_940,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_955,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_454[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_371.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_371[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_830.splice(var_830.indexOf(this),1);
            --var_455;
            this.var_454 = null;
            this.var_832 = null;
            this.var_139 = null;
      ...
      {
         return param1 < this.var_372.length ? this.getAssetByName(this.var_372[param1]) : null;
      }
      ...
      {
         var _loc4_:* = this.var_139[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            if(_loc4_)
            {
               ++this.var_370;
               this.var_372.push(param1);
            }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1437));
         this.var_38 = null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_139)
         {
            if(this.var_139[_loc2_] == param1)
            {
               return this.var_372.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_371)
         {
            _loc3_ = AssetTypeDeclaration(this.var_371[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = this.var_832[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         if(this._file == param1.url && this.var_831)
         {
            if(!this.var_833 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_669,this.var_563);
            }
            this.var_833 = param2;
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_669.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_563[param1]);
      ...
      {
         var _loc2_:IAsset = this.var_139[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_454[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_139[struct.assetName] == null)
                  {
                     ++this.var_370;
                     this.var_372.push(struct.assetName);
                  }
                  this.var_139[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_45,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_454[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_371[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return this.var_139[param1] != null || (this.var_563 != null ? this.var_563[param1] != null : false);
      }
   }
}
