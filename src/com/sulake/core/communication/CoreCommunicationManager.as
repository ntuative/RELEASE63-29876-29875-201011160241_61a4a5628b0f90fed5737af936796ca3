package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1462:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_774[_loc3_];
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1190)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = this.var_947[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1023:
               _loc3_ = new SocketConnection(param1,this,this.var_1462);
               break;
            default:
