package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_237.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_237.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_237 != null)
         {
            ...
            {
               _loc3_ = this.var_237.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_576.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_576[_loc2_]);
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(this.var_237.getValue(_loc2_) != null)
         {
            return this.var_237.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_237.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_237.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return this.var_237.getValue(String(param1)) as IRoomObjectManager;
      }
