package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private var var_457:IAssetLibrary;
      ...
      public function define(param1:XML) : Boolean
      {
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(_loc4_.length() > 0)
            {
               ...
               _loc11_ = this.var_457.getAssetByName(_loc6_);
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0) : Boolean
      {
         ...
         var _loc6_:BitmapDataAsset = this.var_457.getAssetByName(param1) as BitmapDataAsset;
         if(_loc6_ == null)
         {
            _loc6_ = new BitmapDataAsset(this.var_457.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_457.setAsset(param1,_loc6_);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:BitmapDataAsset = this.var_457.getAssetByName(param1) as BitmapDataAsset;
         if(_loc2_ != null)
         {
            this.var_457.removeAsset(_loc2_);
            _loc2_.dispose();
