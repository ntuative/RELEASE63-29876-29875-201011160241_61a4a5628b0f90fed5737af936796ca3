package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_779:Number = 64;
      
      public static const const_1029:Number = 32;
       
      
      private var var_71:Vector3d;
      
      private var var_354:Number = 1.0;
      
      private var var_355:Number = 1.0;
      
      private var var_163:Vector3d;
      
      private var var_1525:Number = 1.0;
      ...
      private var var_356:Number = 1.0;
      ...
      private var var_2597:Number = 500.0;
      
      private var var_1524:Number = 1.0;
      
      private var _x:Vector3d;
      
      private var var_162:Vector3d;
      
      private var var_2598:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_976 = new Vector3d();
         this.var_1525 = 1;
         this.var_1524 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1526 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_218.x;
         var _loc3_:Number = this.var_218.y;
         var _loc4_:Number = this.var_218.z;
         this.var_218.assign(param1);
         if(this.var_218.x != _loc2_ || this.var_218.y != _loc3_ || this.var_218.z != _loc4_)
         {
            ++this.var_136;
         }
      ...
      {
         if(this.var_355 != param1 * this.var_1526)
         {
            this.var_355 = param1 * this.var_1526;
            ++this.var_136;
         }
      }
      ...
      {
         if(this.var_354 != param1 * this.var_1525)
         {
            this.var_354 = param1 * this.var_1525;
            ++this.var_136;
         }
      }
      ...
      {
         if(this.var_356 != param1 * this.var_1524)
         {
            this.var_356 = param1 * this.var_1524;
            ++this.var_136;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_431 != null)
         {
            ...
            this.var_431.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_431.add(_loc3_,_loc4_);
            ++this.var_136;
         }
      }
      ...
      {
         return new Vector3d(this.var_218.x,this.var_218.y,this.var_218.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_976.assign(_loc22_);
         }
         else
         {
            this.var_976.assign(_loc17_);
         }
         ++this.var_136;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_354;
         _loc2_.y *= this.var_356;
         _loc2_.z *= this.var_355;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_976);
         if(_loc3_ < this.var_2598 || _loc3_ > this.var_2597)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_356;
            _loc2_.z *= this.var_355;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_976);
         }
      ...
      {
         return new Vector3d(this.var_71.x * this.var_354,this.var_71.y * this.var_356,this.var_71.z * this.var_355);
      }
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1029;
         }
         else
         {
            this.scale = const_779;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_71.x /= this.var_354;
         this.var_71.y /= this.var_356;
         this.var_71.z /= this.var_355;
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_431 != null)
         {
            ...
            return this.var_431.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_163,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_71.x * this.var_354,this.var_71.y * this.var_356,this.var_71.z * this.var_355);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_162;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_354,param2.y * this.var_356,param2.z * this.var_355);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_354,param3.y * this.var_356,param3.z * this.var_355);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_354,param4.y * this.var_356,param4.z * this.var_355);
