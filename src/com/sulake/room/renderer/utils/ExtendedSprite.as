package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1348:int = 128;
      
      public function ExtendedSprite()
      {
         super();
         this.var_2616 = new Point();
         cacheAsBitmap = false;
         this.enableAlpha();
      }
      ...
      {
         if(this.var_1348 > 255 || bitmapData == null)
         {
            return false;
         }
      ...
      {
         if(param1 != this.var_1777 || param2 != this.var_1776)
         {
