   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_666 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_666 += param2.width * param2.height * 4;
      }
      ...
      public function compress() : void
      {
         ...
         {
            this.var_369.sortOn("useCount",0 | 0);
            _loc2_ = this.var_369.length - 1;
            while(_loc2_ >= 0)
            {
               _loc1_ = this.var_369[_loc2_] as BitmapDataCacheItem;
            ...
            this.var_369.splice(_loc2_,this.var_369.length - _loc2_);
            if(this.memUsage > this.memLimit)
            {
               this.var_369.sortOn("memUsage",Array.NUMERIC);
               while(this.memUsage > this.memLimit)
               {
                  _loc1_ = this.var_369.pop() as BitmapDataCacheItem;
                  if(_loc1_ == null)
                  {
                     break;
                  }
