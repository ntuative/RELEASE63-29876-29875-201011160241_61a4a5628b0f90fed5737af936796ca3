package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1510:int = 50;
      ...
      private var var_1217:IRoomRenderingCanvasMouseListener = null;
      
      private var var_425:Point;
      
      private var var_217:Sprite;
      ...
      private var var_2119:Number = -1.0E7;
      
      private var var_2120:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_49.name = "canvas";
         this.var_49.mouseEnabled = false;
         this.var_217.addChild(this.var_49);
         this.var_49.mouseEnabled = true;
         this.var_49.doubleClickEnabled = true;
         this.var_49.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_49.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
         this._geometry = new RoomGeometry(param5,new Vector3d(-135,30,0),new Vector3d(11,11,5),new Vector3d(-135,0.5,0));
         this.var_216 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
      ...
      {
         var _loc11_:Number = param1 - this.var_634 / 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_533 != null)
         {
            ...
            {
               this.cleanSprite(this.var_533[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_533 = [];
         }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_753 = true;
            if(this.var_114 != null && this.var_217.getChildIndex(this.var_114) < 0)
            {
               this.var_217.addChild(this.var_114);
               this.var_49.mask = this.var_114;
            }
         }
         else if(!param1 && this.var_753)
         {
            this.var_753 = false;
            if(this.var_114 != null && this.var_217.getChildIndex(this.var_114) >= 0)
            {
               this.var_217.removeChild(this.var_114);
               this.var_49.mask = null;
            }
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_294 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_294.getKey(_loc1_);
            _loc3_ = this.var_294.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1217.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      {
         this.var_425.x -= param1 - this.var_530;
         this.var_530 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_425.y -= param1 - this.var_531;
         this.var_531 = param1;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_530;
         param2 -= this.var_531;
         this.var_425.x = param1;
         this.var_425.y = param2;
         if(this.var_974 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1516;
         }
         this.var_1516 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_974;
         return this.var_1516;
      }
      ...
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         ...
         {
            this.var_294.add(param2,param1);
         }
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         var _loc13_:* = null;
         var _loc14_:int = 0;
         _loc14_ = this.var_635 - 1;
         while(_loc14_ >= 0)
         {
            _loc10_ = this.var_49.getChildAt(_loc14_) as ExtendedSprite;
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2119 || param2 != this.var_2120)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_216.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_216.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_532.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_532.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_530;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_531;
                  if(_loc19_ < this.var_634 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_426.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_530;
                     _loc17_.y = _loc20_ - this.var_531;
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_114 != null)
         {
            this.var_114.graphics.clear();
         }
         else
         {
            this.var_114 = new Sprite();
            this.var_114.name = "mask";
            if(this.var_753)
            {
               this.var_217.addChild(this.var_114);
               this.var_49.mask = this.var_114;
         ...
         this.var_114.graphics.beginFill(0);
         this.var_114.graphics.drawRect(0,0,param1,param2);
         this.var_634 = param1;
         this._ht = param2;
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(param1 == this.var_2123)
         {
            return;
         }
         this.var_216.compress();
         ...
         if(this.var_634 != this.var_2122 || this._ht != this.var_2121)
         {
            _loc9_ = true;
         }
         if(this.var_49.x != this.var_530 || this.var_49.y != this.var_531)
         {
            this.var_49.x = this.var_530;
            this.var_49.y = this.var_531;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_426.sortOn("z",0 | 0);
         if(_loc5_ < this.var_426.length)
         {
            this.var_426.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_426[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2122 = this.var_634;
         this.var_2121 = this._ht;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_216.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_216.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      {
         if(param1 < 0 || param1 >= this.var_49.numChildren)
         {
            return null;
         }
         return this.var_49.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_635 || this.var_635 == 0)
         {
            _loc5_ = this.var_49.numChildren - 1;
            while(_loc5_ >= param1)
            {
               _loc3_ = this.var_49.getChildAt(_loc5_);
      ...
      public function update() : void
      {
         if(this.var_974 == 0)
         {
            this.checkMouseHits(this.var_425.x,this.var_425.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_974 = 0;
         ++this.var_1517;
      }
      ...
      {
         if(param1 < 0 || param1 >= this.var_426.length)
         {
            return null;
         }
         return this.var_426[param1] as SortableSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_533.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_49.numChildren)
         {
            this.var_49.addChild(_loc3_);
         }
         else
         {
            this.var_49.addChildAt(_loc3_,param2);
         }
         ++this.var_635;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         var _loc6_:* = null;
         if(param1 >= this.var_49.numChildren)
         {
            this.createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = this.var_49.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_49.removeChildAt(param1);
